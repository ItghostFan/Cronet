...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 TranslationTableDefaultTypeInternal _TranslationTable_default_instance_;
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 ChromeHistorgramTranslationTable_HashToNameEntry_DoNotUseDefaultTypeInternal _ChromeHistorgramTranslationTable_HashToNameEntry_DoNotUse_default_instance_;
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 ChromeHistorgramTranslationTableDefaultTypeInternal _ChromeHistorgramTranslationTable_default_instance_;
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 ChromeUserEventTranslationTable_ActionHashToNameEntry_DoNotUseDefaultTypeInternal _ChromeUserEventTranslationTable_ActionHashToNameEntry_DoNotUse_default_instance_;
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 ChromeUserEventTranslationTableDefaultTypeInternal _ChromeUserEventTranslationTable_default_instance_;
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 ChromePerformanceMarkTranslationTable_SiteHashToNameEntry_DoNotUseDefaultTypeInternal _ChromePerformanceMarkTranslationTable_SiteHashToNameEntry_DoNotUse_default_instance_;
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 ChromePerformanceMarkTranslationTable_MarkHashToNameEntry_DoNotUseDefaultTypeInternal _ChromePerformanceMarkTranslationTable_MarkHashToNameEntry_DoNotUse_default_instance_;
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 ChromePerformanceMarkTranslationTableDefaultTypeInternal _ChromePerformanceMarkTranslationTable_default_instance_;
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 SliceNameTranslationTable_RawToDeobfuscatedNameEntry_DoNotUseDefaultTypeInternal _SliceNameTranslationTable_RawToDeobfuscatedNameEntry_DoNotUse_default_instance_;
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 SliceNameTranslationTableDefaultTypeInternal _SliceNameTranslationTable_default_instance_;
}  // namespace protos
}  // namespace perfetto
namespace perfetto {
namespace protos {
...
TranslationTable::_Internal::chrome_histogram(const TranslationTable* msg) {
  return *msg->table_.chrome_histogram_;
}
...
TranslationTable::_Internal::chrome_user_event(const TranslationTable* msg) {
  return *msg->table_.chrome_user_event_;
}
...
TranslationTable::TranslationTable(const TranslationTable& from)
  ...
  switch (from.table_case()) {
    case kChromeHistogram: {
      _internal_mutable_chrome_histogram()->::perfetto::protos::ChromeHistorgramTranslationTable::MergeFrom(from._internal_chrome_histogram());
      break;
    }
    case kChromeUserEvent: {
      _internal_mutable_chrome_user_event()->::perfetto::protos::ChromeUserEventTranslationTable::MergeFrom(from._internal_chrome_user_event());
      break;
    }
    case kChromePerformanceMark: {
      _internal_mutable_chrome_performance_mark()->::perfetto::protos::ChromePerformanceMarkTranslationTable::MergeFrom(from._internal_chrome_performance_mark());
      break;
    }
    case kSliceName: {
      _internal_mutable_slice_name()->::perfetto::protos::SliceNameTranslationTable::MergeFrom(from._internal_slice_name());
      break;
    }
    case TABLE_NOT_SET: {
      break;
...
ChromeHistorgramTranslationTable::ChromeHistorgramTranslationTable(const ChromeHistorgramTranslationTable& from)
  : ::PROTOBUF_NAMESPACE_ID::MessageLite() {
  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
  hash_to_name_.MergeFrom(from.hash_to_name_);
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          do {
            ptr += 1;
            ptr = ctx->ParseMessage(&hash_to_name_, ptr);
            CHK_(ptr);
...
void ChromeHistorgramTranslationTable::InternalSwap(ChromeHistorgramTranslationTable* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  hash_to_name_.InternalSwap(&other->hash_to_name_);
}
...
ChromeUserEventTranslationTable::ChromeUserEventTranslationTable(const ChromeUserEventTranslationTable& from)
  : ::PROTOBUF_NAMESPACE_ID::MessageLite() {
  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
  action_hash_to_name_.MergeFrom(from.action_hash_to_name_);
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          do {
            ptr += 1;
            ptr = ctx->ParseMessage(&action_hash_to_name_, ptr);
            CHK_(ptr);
            if (!ctx->DataAvailable(ptr)) break;
          } while (::PROTOBUF_NAMESPACE_ID::internal::ExpectTag<10>(ptr));
        } else
...
void ChromeUserEventTranslationTable::InternalSwap(ChromeUserEventTranslationTable* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  action_hash_to_name_.InternalSwap(&other->action_hash_to_name_);
}
...
ChromePerformanceMarkTranslationTable::ChromePerformanceMarkTranslationTable(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::MessageLite(arena, is_message_owned),
  site_hash_to_name_(arena),
  mark_hash_to_name_(arena) {
  SharedCtor();
...
ChromePerformanceMarkTranslationTable::ChromePerformanceMarkTranslationTable(const ChromePerformanceMarkTranslationTable& from)
  : ::PROTOBUF_NAMESPACE_ID::MessageLite() {
  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
  site_hash_to_name_.MergeFrom(from.site_hash_to_name_);
  mark_hash_to_name_.MergeFrom(from.mark_hash_to_name_);
...
inline void ChromePerformanceMarkTranslationTable::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  site_hash_to_name_.Destruct();
  mark_hash_to_name_.Destruct();
}
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          do {
            ptr += 1;
            ptr = ctx->ParseMessage(&site_hash_to_name_, ptr);
            CHK_(ptr);
            if (!ctx->DataAvailable(ptr)) break;
          } while (::PROTOBUF_NAMESPACE_ID::internal::ExpectTag<10>(ptr));
        } else
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          do {
            ptr += 1;
            ptr = ctx->ParseMessage(&mark_hash_to_name_, ptr);
            CHK_(ptr);
            if (!ctx->DataAvailable(ptr)) break;
...
void ChromePerformanceMarkTranslationTable::InternalSwap(ChromePerformanceMarkTranslationTable* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  site_hash_to_name_.InternalSwap(&other->site_hash_to_name_);
  mark_hash_to_name_.InternalSwap(&other->mark_hash_to_name_);
}
...
SliceNameTranslationTable::SliceNameTranslationTable(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::MessageLite(arena, is_message_owned),
  raw_to_deobfuscated_name_(arena) {
  SharedCtor();
...
SliceNameTranslationTable::SliceNameTranslationTable(const SliceNameTranslationTable& from)
  : ::PROTOBUF_NAMESPACE_ID::MessageLite() {
  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
  raw_to_deobfuscated_name_.MergeFrom(from.raw_to_deobfuscated_name_);
...
inline void SliceNameTranslationTable::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  raw_to_deobfuscated_name_.Destruct();
}
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          do {
            ptr += 1;
            ptr = ctx->ParseMessage(&raw_to_deobfuscated_name_, ptr);
            CHK_(ptr);
            if (!ctx->DataAvailable(ptr)) break;
          } while (::PROTOBUF_NAMESPACE_ID::internal::ExpectTag<10>(ptr));
        } else
...
void SliceNameTranslationTable::InternalSwap(SliceNameTranslationTable* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  raw_to_deobfuscated_name_.InternalSwap(&other->raw_to_deobfuscated_name_);
}
