...
void SmapsEntry::set_module_debugid(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000004u;
 module_debugid_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void SmapsEntry::_internal_set_module_debugid(const std::string& value) {
  _has_bits_[0] |= 0x00000004u;
  module_debugid_.Set(value, GetArenaForAllocation());
}
inline std::string* SmapsEntry::_internal_mutable_module_debugid() {
  _has_bits_[0] |= 0x00000004u;
  return module_debugid_.Mutable(GetArenaForAllocation());
}
inline std::string* SmapsEntry::release_module_debugid() {
  ...
  _has_bits_[0] &= ~0x00000004u;
  auto* p = module_debugid_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (module_debugid_.IsDefault()) {
...
inline void SmapsEntry::set_allocated_module_debugid(std::string* module_debugid) {
  ...
  module_debugid_.SetAllocated(module_debugid, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (module_debugid_.IsDefault()) {
    module_debugid_.Set("", GetArenaForAllocation());
  }
...
inline void SmapsEntry::clear_module_debug_path() {
  module_debug_path_.ClearToEmpty();
...
void SmapsEntry::set_module_debug_path(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000008u;
 module_debug_path_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void SmapsEntry::_internal_set_module_debug_path(const std::string& value) {
  _has_bits_[0] |= 0x00000008u;
  module_debug_path_.Set(value, GetArenaForAllocation());
}
inline std::string* SmapsEntry::_internal_mutable_module_debug_path() {
  _has_bits_[0] |= 0x00000008u;
  return module_debug_path_.Mutable(GetArenaForAllocation());
}
inline std::string* SmapsEntry::release_module_debug_path() {
  ...
  _has_bits_[0] &= ~0x00000008u;
  auto* p = module_debug_path_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (module_debug_path_.IsDefault()) {
...
inline void SmapsEntry::set_allocated_module_debug_path(std::string* module_debug_path) {
  ...
  module_debug_path_.SetAllocated(module_debug_path, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (module_debug_path_.IsDefault()) {
    module_debug_path_.Set("", GetArenaForAllocation());
  }
