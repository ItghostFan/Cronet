...
void InternedString::set_str(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 str_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void Line::clear_source_file_name() {
  source_file_name_.ClearToEmpty();
  _has_bits_[0] &= ~0x00000002u;
}
...
void Line::set_source_file_name(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000002u;
 source_file_name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void Line::_internal_set_source_file_name(const std::string& value) {
  _has_bits_[0] |= 0x00000002u;
  source_file_name_.Set(value, GetArenaForAllocation());
}
inline std::string* Line::_internal_mutable_source_file_name() {
  _has_bits_[0] |= 0x00000002u;
  return source_file_name_.Mutable(GetArenaForAllocation());
}
inline std::string* Line::release_source_file_name() {
  ...
  _has_bits_[0] &= ~0x00000002u;
  auto* p = source_file_name_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (source_file_name_.IsDefault()) {
...
inline void Line::set_allocated_source_file_name(std::string* source_file_name) {
  ...
  source_file_name_.SetAllocated(source_file_name, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (source_file_name_.IsDefault()) {
    source_file_name_.Set("", GetArenaForAllocation());
  }
