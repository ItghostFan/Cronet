...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 TraceUuidDefaultTypeInternal _TraceUuid_default_instance_;
}  // namespace protos
}  // namespace perfetto
namespace perfetto {
namespace protos {
...
class TraceUuid::_Internal {
 public:
  using HasBits = decltype(std::declval<TraceUuid>()._has_bits_);
...
TraceUuid::TraceUuid(const TraceUuid& from)
  ...
  ::memcpy(&msb_, &from.msb_,
    static_cast<size_t>(reinterpret_cast<char*>(&lsb_) -
    reinterpret_cast<char*>(&msb_)) + sizeof(lsb_));
  // @@protoc_insertion_point(copy_constructor:perfetto.protos.TraceUuid)
}

inline void TraceUuid::SharedCtor() {
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&msb_) - reinterpret_cast<char*>(this)),
    0, static_cast<size_t>(reinterpret_cast<char*>(&lsb_) -
    reinterpret_cast<char*>(&msb_)) + sizeof(lsb_));
}
...
// @@protoc_insertion_point(message_clear_start:perfetto.protos.TraceUuid)
  ...
  if (cached_has_bits & 0x00000003u) {
    ::memset(&msb_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&lsb_) -
        reinterpret_cast<char*>(&msb_)) + sizeof(lsb_));
  }
  _has_bits_.Clear();
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 8)) {
          ...
          msb_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 16)) {
          ...
          lsb_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
void TraceUuid::InternalSwap(TraceUuid* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(TraceUuid, lsb_)
      + sizeof(TraceUuid::lsb_)
      - PROTOBUF_FIELD_OFFSET(TraceUuid, msb_)>(
          reinterpret_cast<char*>(&msb_),
          reinterpret_cast<char*>(&other->msb_));
}
