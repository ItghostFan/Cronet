...
PROTOBUF_CONSTEXPR CpuInfo_Cpu::CpuInfo_Cpu(
  ...
  : frequencies_()
  , processor_(&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}){}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 CpuInfo_CpuDefaultTypeInternal _CpuInfo_Cpu_default_instance_;
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 CpuInfoDefaultTypeInternal _CpuInfo_default_instance_;
}  // namespace protos
}  // namespace perfetto
namespace perfetto {
namespace protos {
...
CpuInfo_Cpu::CpuInfo_Cpu(const CpuInfo_Cpu& from)
  ...
  processor_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    processor_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_processor()) {
    processor_.Set(from._internal_processor(), 
...
void CpuInfo_Cpu::InternalSwap(CpuInfo_Cpu* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &processor_, lhs_arena,
      &other->processor_, rhs_arena
  );
}
