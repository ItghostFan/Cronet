...
void TestEvent_TestPayload::set_single_string(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 single_string_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* TestEvent_TestPayload::release_single_string() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  auto* p = single_string_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (single_string_.IsDefault()) {
...
inline void TestEvent_TestPayload::set_allocated_single_string(std::string* single_string) {
  ...
  single_string_.SetAllocated(single_string, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (single_string_.IsDefault()) {
    single_string_.Set("", GetArenaForAllocation());
  }
