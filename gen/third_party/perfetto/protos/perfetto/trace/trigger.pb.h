...
void Trigger::set_trigger_name(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 trigger_name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void Trigger::_internal_set_trigger_name(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  trigger_name_.Set(value, GetArenaForAllocation());
}
inline std::string* Trigger::_internal_mutable_trigger_name() {
  _has_bits_[0] |= 0x00000001u;
  return trigger_name_.Mutable(GetArenaForAllocation());
}
inline std::string* Trigger::release_trigger_name() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  auto* p = trigger_name_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (trigger_name_.IsDefault()) {
...
inline void Trigger::set_allocated_trigger_name(std::string* trigger_name) {
  ...
  trigger_name_.SetAllocated(trigger_name, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (trigger_name_.IsDefault()) {
    trigger_name_.Set("", GetArenaForAllocation());
  }
