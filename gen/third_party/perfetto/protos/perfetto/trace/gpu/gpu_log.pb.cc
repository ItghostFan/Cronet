...
PROTOBUF_CONSTEXPR GpuLog::GpuLog(
  ...
  , log_message_(&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{})
  , severity_(0)
{}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 GpuLogDefaultTypeInternal _GpuLog_default_instance_;
}  // namespace protos
}  // namespace perfetto
namespace perfetto {
namespace protos {
...
GpuLog::GpuLog(const GpuLog& from)
  ...
  log_message_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    log_message_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_log_message()) {
    log_message_.Set(from._internal_log_message(), 
      GetArenaForAllocation());
  }
...
void GpuLog::InternalSwap(GpuLog* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &log_message_, lhs_arena,
      &other->log_message_, rhs_arena
  );
