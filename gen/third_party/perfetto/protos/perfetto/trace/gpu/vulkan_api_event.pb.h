...
void VulkanApiEvent_VkDebugUtilsObjectName::set_object_name(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 object_name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void VulkanApiEvent_VkDebugUtilsObjectName::_internal_set_object_name(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  object_name_.Set(value, GetArenaForAllocation());
}
inline std::string* VulkanApiEvent_VkDebugUtilsObjectName::_internal_mutable_object_name() {
  _has_bits_[0] |= 0x00000001u;
  return object_name_.Mutable(GetArenaForAllocation());
}
inline std::string* VulkanApiEvent_VkDebugUtilsObjectName::release_object_name() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  auto* p = object_name_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (object_name_.IsDefault()) {
...
inline void VulkanApiEvent_VkDebugUtilsObjectName::set_allocated_object_name(std::string* object_name) {
  ...
  object_name_.SetAllocated(object_name, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (object_name_.IsDefault()) {
    object_name_.Set("", GetArenaForAllocation());
  }
...
inline ::perfetto::protos::VulkanApiEvent_VkDebugUtilsObjectName* VulkanApiEvent::_internal_mutable_vk_debug_utils_object_name() {
  if (!_internal_has_vk_debug_utils_object_name()) {
    clear_event();
    set_has_vk_debug_utils_object_name();
    event_.vk_debug_utils_object_name_ = CreateMaybeMessage< ::perfetto::protos::VulkanApiEvent_VkDebugUtilsObjectName >(GetArenaForAllocation());
  }
...
inline ::perfetto::protos::VulkanApiEvent_VkQueueSubmit* VulkanApiEvent::_internal_mutable_vk_queue_submit() {
  if (!_internal_has_vk_queue_submit()) {
    clear_event();
    set_has_vk_queue_submit();
    event_.vk_queue_submit_ = CreateMaybeMessage< ::perfetto::protos::VulkanApiEvent_VkQueueSubmit >(GetArenaForAllocation());
  }
