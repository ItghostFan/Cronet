...
void GpuLog::set_log_message(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000002u;
 log_message_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void GpuLog::_internal_set_log_message(const std::string& value) {
  _has_bits_[0] |= 0x00000002u;
  log_message_.Set(value, GetArenaForAllocation());
}
inline std::string* GpuLog::_internal_mutable_log_message() {
  _has_bits_[0] |= 0x00000002u;
  return log_message_.Mutable(GetArenaForAllocation());
}
inline std::string* GpuLog::release_log_message() {
  ...
  _has_bits_[0] &= ~0x00000002u;
  auto* p = log_message_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (log_message_.IsDefault()) {
...
inline void GpuLog::set_allocated_log_message(std::string* log_message) {
  ...
  log_message_.SetAllocated(log_message, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (log_message_.IsDefault()) {
    log_message_.Set("", GetArenaForAllocation());
  }
