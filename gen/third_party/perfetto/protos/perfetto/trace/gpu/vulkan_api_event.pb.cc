...
PROTOBUF_CONSTEXPR VulkanApiEvent_VkDebugUtilsObjectName::VulkanApiEvent_VkDebugUtilsObjectName(
  ...
  : object_name_(&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{})
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 VulkanApiEvent_VkDebugUtilsObjectNameDefaultTypeInternal _VulkanApiEvent_VkDebugUtilsObjectName_default_instance_;
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 VulkanApiEvent_VkQueueSubmitDefaultTypeInternal _VulkanApiEvent_VkQueueSubmit_default_instance_;
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 VulkanApiEventDefaultTypeInternal _VulkanApiEvent_default_instance_;
}  // namespace protos
}  // namespace perfetto
namespace perfetto {
namespace protos {
...
VulkanApiEvent_VkDebugUtilsObjectName::VulkanApiEvent_VkDebugUtilsObjectName(const VulkanApiEvent_VkDebugUtilsObjectName& from)
  ...
  object_name_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    object_name_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_object_name()) {
    object_name_.Set(from._internal_object_name(), 
...
void VulkanApiEvent_VkDebugUtilsObjectName::InternalSwap(VulkanApiEvent_VkDebugUtilsObjectName* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &object_name_, lhs_arena,
      &other->object_name_, rhs_arena
  );
