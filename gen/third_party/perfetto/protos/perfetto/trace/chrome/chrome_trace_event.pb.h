...
inline void ChromeTraceEvent_Arg::set_json_value(ArgT0&& arg0, ArgT... args) {
  if (!_internal_has_json_value()) {
    clear_value();
    set_has_json_value();
    value_.json_value_.InitDefault();
  }
  value_.json_value_.Set( static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void ChromeTraceEvent_Arg::_internal_set_json_value(const std::string& value) {
  ...
  value_.json_value_.Set(value, GetArenaForAllocation());
}
inline std::string* ChromeTraceEvent_Arg::_internal_mutable_json_value() {
  ...
  return value_.json_value_.Mutable(      GetArenaForAllocation());
}
inline std::string* ChromeTraceEvent_Arg::release_json_value() {
  ...
  if (_internal_has_json_value()) {
    clear_has_value();
    return value_.json_value_.Release();
  } else {
    return nullptr;
  }
}
inline void ChromeTraceEvent_Arg::set_allocated_json_value(std::string* json_value) {
  ...
  if (json_value != nullptr) {
    set_has_json_value();
    value_.json_value_.InitAllocated(json_value, GetArenaForAllocation());
  }
...
inline ::perfetto::protos::ChromeTracedValue* ChromeTraceEvent_Arg::_internal_mutable_traced_value() {
  if (!_internal_has_traced_value()) {
    clear_value();
    set_has_traced_value();
    value_.traced_value_ = CreateMaybeMessage< ::perfetto::protos::ChromeTracedValue >(GetArenaForAllocation());
  }
...
inline void ChromeTraceEvent::clear_category_group_name() {
  category_group_name_.ClearToEmpty();
  _has_bits_[0] &= ~0x00000004u;
}
...
void ChromeTraceEvent::set_category_group_name(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000004u;
 category_group_name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void ChromeTraceEvent::_internal_set_category_group_name(const std::string& value) {
  _has_bits_[0] |= 0x00000004u;
  category_group_name_.Set(value, GetArenaForAllocation());
}
inline std::string* ChromeTraceEvent::_internal_mutable_category_group_name() {
  _has_bits_[0] |= 0x00000004u;
  return category_group_name_.Mutable(GetArenaForAllocation());
}
inline std::string* ChromeTraceEvent::release_category_group_name() {
  ...
  _has_bits_[0] &= ~0x00000004u;
  auto* p = category_group_name_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (category_group_name_.IsDefault()) {
...
inline void ChromeTraceEvent::set_allocated_category_group_name(std::string* category_group_name) {
  ...
  category_group_name_.SetAllocated(category_group_name, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (category_group_name_.IsDefault()) {
    category_group_name_.Set("", GetArenaForAllocation());
  }
