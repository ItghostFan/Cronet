...
inline void PerfettoMetatrace_Arg::clear_key() {
  if (_internal_has_key()) {
    key_or_interned_key_.key_.Destroy();
...
inline void PerfettoMetatrace_Arg::set_key(ArgT0&& arg0, ArgT... args) {
  if (!_internal_has_key()) {
    ...
    set_has_key();
    key_or_interned_key_.key_.InitDefault();
  }
  key_or_interned_key_.key_.Set( static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline const std::string& PerfettoMetatrace_Arg::_internal_key() const {
  if (_internal_has_key()) {
    return key_or_interned_key_.key_.Get();
  }
...
inline void PerfettoMetatrace_Arg::_internal_set_key(const std::string& value) {
  ...
  key_or_interned_key_.key_.Set(value, GetArenaForAllocation());
}
inline std::string* PerfettoMetatrace_Arg::_internal_mutable_key() {
  ...
  return key_or_interned_key_.key_.Mutable(      GetArenaForAllocation());
}
inline std::string* PerfettoMetatrace_Arg::release_key() {
  ...
  if (_internal_has_key()) {
    clear_has_key_or_interned_key();
    return key_or_interned_key_.key_.Release();
  } else {
    return nullptr;
  }
}
inline void PerfettoMetatrace_Arg::set_allocated_key(std::string* key) {
  ...
  if (key != nullptr) {
    set_has_key();
    key_or_interned_key_.key_.InitAllocated(key, GetArenaForAllocation());
  }
...
inline void PerfettoMetatrace_Arg::_internal_set_key_iid(uint64_t value) {
  ...
  key_or_interned_key_.key_iid_ = value;
}
...
inline void PerfettoMetatrace_Arg::clear_value() {
  if (_internal_has_value()) {
    value_or_interned_value_.value_.Destroy();
...
inline void PerfettoMetatrace_Arg::set_value(ArgT0&& arg0, ArgT... args) {
  if (!_internal_has_value()) {
    ...
    set_has_value();
    value_or_interned_value_.value_.InitDefault();
  }
  value_or_interned_value_.value_.Set( static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline const std::string& PerfettoMetatrace_Arg::_internal_value() const {
  if (_internal_has_value()) {
    return value_or_interned_value_.value_.Get();
  }
  return ::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited();
}
inline void PerfettoMetatrace_Arg::_internal_set_value(const std::string& value) {
  ...
  value_or_interned_value_.value_.Set(value, GetArenaForAllocation());
}
inline std::string* PerfettoMetatrace_Arg::_internal_mutable_value() {
  ...
  return value_or_interned_value_.value_.Mutable(      GetArenaForAllocation());
}
inline std::string* PerfettoMetatrace_Arg::release_value() {
  ...
  if (_internal_has_value()) {
    clear_has_value_or_interned_value();
    return value_or_interned_value_.value_.Release();
  } else {
    return nullptr;
  }
}
inline void PerfettoMetatrace_Arg::set_allocated_value(std::string* value) {
  ...
  if (value != nullptr) {
    set_has_value();
    value_or_interned_value_.value_.InitAllocated(value, GetArenaForAllocation());
  }
...
inline void PerfettoMetatrace_Arg::_internal_set_value_iid(uint64_t value) {
  ...
  value_or_interned_value_.value_iid_ = value;
}
...
inline void PerfettoMetatrace_Arg::clear_has_key_or_interned_key() {
  _oneof_case_[0] = KEY_OR_INTERNED_KEY_NOT_SET;
}
...
inline void PerfettoMetatrace::clear_event_name() {
  if (_internal_has_event_name()) {
    record_type_.event_name_.Destroy();
    clear_has_record_type();
  }
}
...
inline void PerfettoMetatrace::set_event_name(ArgT0&& arg0, ArgT... args) {
  if (!_internal_has_event_name()) {
    clear_record_type();
    set_has_event_name();
    record_type_.event_name_.InitDefault();
  }
  record_type_.event_name_.Set( static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline const std::string& PerfettoMetatrace::_internal_event_name() const {
  if (_internal_has_event_name()) {
    return record_type_.event_name_.Get();
  }
  return ::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited();
}
inline void PerfettoMetatrace::_internal_set_event_name(const std::string& value) {
  ...
  record_type_.event_name_.Set(value, GetArenaForAllocation());
}
inline std::string* PerfettoMetatrace::_internal_mutable_event_name() {
  ...
  return record_type_.event_name_.Mutable(      GetArenaForAllocation());
}
inline std::string* PerfettoMetatrace::release_event_name() {
  ...
  if (_internal_has_event_name()) {
    clear_has_record_type();
    return record_type_.event_name_.Release();
  } else {
    return nullptr;
  }
}
inline void PerfettoMetatrace::set_allocated_event_name(std::string* event_name) {
  ...
  if (event_name != nullptr) {
    set_has_event_name();
    record_type_.event_name_.InitAllocated(event_name, GetArenaForAllocation());
  }
...
inline void PerfettoMetatrace::_internal_set_event_name_iid(uint64_t value) {
  ...
  record_type_.event_name_iid_ = value;
}
...
inline void PerfettoMetatrace::clear_counter_name() {
  if (_internal_has_counter_name()) {
    record_type_.counter_name_.Destroy();
    clear_has_record_type();
  }
}
...
inline void PerfettoMetatrace::set_counter_name(ArgT0&& arg0, ArgT... args) {
  if (!_internal_has_counter_name()) {
    ...
    record_type_.counter_name_.InitDefault();
  }
  record_type_.counter_name_.Set( static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline const std::string& PerfettoMetatrace::_internal_counter_name() const {
  if (_internal_has_counter_name()) {
    return record_type_.counter_name_.Get();
  }
  return ::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited();
}
inline void PerfettoMetatrace::_internal_set_counter_name(const std::string& value) {
  ...
  record_type_.counter_name_.Set(value, GetArenaForAllocation());
}
inline std::string* PerfettoMetatrace::_internal_mutable_counter_name() {
  ...
  return record_type_.counter_name_.Mutable(      GetArenaForAllocation());
}
inline std::string* PerfettoMetatrace::release_counter_name() {
  ...
  if (_internal_has_counter_name()) {
    clear_has_record_type();
    return record_type_.counter_name_.Release();
  } else {
    return nullptr;
  }
}
inline void PerfettoMetatrace::set_allocated_counter_name(std::string* counter_name) {
  ...
  if (counter_name != nullptr) {
    set_has_counter_name();
    record_type_.counter_name_.InitAllocated(counter_name, GetArenaForAllocation());
  }
...
inline ::perfetto::protos::PerfettoMetatrace_InternedString* PerfettoMetatrace::mutable_interned_strings(int index) {
  ...
  return interned_strings_.Mutable(index);
}
...
inline const ::perfetto::protos::PerfettoMetatrace_InternedString& PerfettoMetatrace::_internal_interned_strings(int index) const {
  return interned_strings_.Get(index);
}
