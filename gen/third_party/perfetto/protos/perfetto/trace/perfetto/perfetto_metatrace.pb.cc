...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 PerfettoMetatrace_ArgDefaultTypeInternal _PerfettoMetatrace_Arg_default_instance_;
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 PerfettoMetatrace_InternedStringDefaultTypeInternal _PerfettoMetatrace_InternedString_default_instance_;
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 PerfettoMetatraceDefaultTypeInternal _PerfettoMetatrace_default_instance_;
}  // namespace protos
}  // namespace perfetto
namespace perfetto {
namespace protos {
...
PerfettoMetatrace_Arg::PerfettoMetatrace_Arg(const PerfettoMetatrace_Arg& from)
  ...
  switch (from.value_or_interned_value_case()) {
    ...
    case kValueIid: {
      _internal_set_value_iid(from._internal_value_iid());
      break;
    }
...
void PerfettoMetatrace_Arg::InternalSwap(PerfettoMetatrace_Arg* other) {
  ...
  swap(key_or_interned_key_, other->key_or_interned_key_);
  swap(value_or_interned_value_, other->value_or_interned_value_);
...
class PerfettoMetatrace_InternedString::_Internal {
 public:
  using HasBits = decltype(std::declval<PerfettoMetatrace_InternedString>()._has_bits_);
...
PerfettoMetatrace::PerfettoMetatrace(const PerfettoMetatrace& from)
  : ::PROTOBUF_NAMESPACE_ID::MessageLite(),
      _has_bits_(from._has_bits_),
      args_(from.args_),
      interned_strings_(from.interned_strings_) {
  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
  ...
  switch (from.record_type_case()) {
    ...
    case kEventNameIid: {
      _internal_set_event_name_iid(from._internal_event_name_iid());
      break;
    }
    case kCounterName: {
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&event_duration_ns_) - reinterpret_cast<char*>(this)),
    0, static_cast<size_t>(reinterpret_cast<char*>(&has_overruns_) -
    reinterpret_cast<char*>(&event_duration_ns_)) + sizeof(has_overruns_));
clear_has_record_type();
}
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 24)) {
          ...
          event_duration_ns_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 32)) {
          ...
          counter_value_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 6:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 48)) {
          ...
          has_overruns_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
// @@protoc_insertion_point(message_byte_size_start:perfetto.protos.PerfettoMetatrace)
  ...
  for (const auto& msg : this->interned_strings_) {
    total_size +=
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::MessageSize(msg);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:perfetto.protos.PerfettoMetatrace)
  ...
  interned_strings_.MergeFrom(from.interned_strings_);
  cached_has_bits = from._has_bits_[0];
  if (cached_has_bits & 0x0000000fu) {
    if (cached_has_bits & 0x00000001u) {
...
void PerfettoMetatrace::InternalSwap(PerfettoMetatrace* other) {
  ...
  interned_strings_.InternalSwap(&other->interned_strings_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(PerfettoMetatrace, has_overruns_)
      + sizeof(PerfettoMetatrace::has_overruns_)
      - PROTOBUF_FIELD_OFFSET(PerfettoMetatrace, event_duration_ns_)>(
          reinterpret_cast<char*>(&event_duration_ns_),
          reinterpret_cast<char*>(&other->event_duration_ns_));
