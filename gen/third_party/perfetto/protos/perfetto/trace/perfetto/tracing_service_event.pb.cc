...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 TracingServiceEventDefaultTypeInternal _TracingServiceEvent_default_instance_;
}  // namespace protos
}  // namespace perfetto
namespace perfetto {
namespace protos {
...
TracingServiceEvent::TracingServiceEvent(const TracingServiceEvent& from)
  ...
  switch (from.event_type_case()) {
    case kTracingStarted: {
      _internal_set_tracing_started(from._internal_tracing_started());
      break;
    }
    ...
    case kAllDataSourcesFlushed: {
      _internal_set_all_data_sources_flushed(from._internal_all_data_sources_flushed());
      break;
    }
    case kReadTracingBuffersCompleted: {
      _internal_set_read_tracing_buffers_completed(from._internal_read_tracing_buffers_completed());
      break;
    }
    case kTracingDisabled: {
      _internal_set_tracing_disabled(from._internal_tracing_disabled());
      break;
    }
    case kSeizedForBugreport: {
      _internal_set_seized_for_bugreport(from._internal_seized_for_bugreport());
      break;
    }
