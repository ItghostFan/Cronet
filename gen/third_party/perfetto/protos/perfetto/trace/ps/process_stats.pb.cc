...
ProcessStats_Process::ProcessStats_Process(const ProcessStats_Process& from)
  ...
  ::memcpy(&vm_size_kb_, &from.vm_size_kb_,
    static_cast<size_t>(reinterpret_cast<char*>(&smr_pss_shmem_kb_) -
    reinterpret_cast<char*>(&vm_size_kb_)) + sizeof(smr_pss_shmem_kb_));
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    0, static_cast<size_t>(reinterpret_cast<char*>(&smr_pss_shmem_kb_) -
    reinterpret_cast<char*>(&vm_size_kb_)) + sizeof(smr_pss_shmem_kb_));
}
...
// @@protoc_insertion_point(message_clear_start:perfetto.protos.ProcessStats.Process)
  ...
  if (cached_has_bits & 0x00030000u) {
    ::memset(&smr_pss_file_kb_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&smr_pss_shmem_kb_) -
        reinterpret_cast<char*>(&smr_pss_file_kb_)) + sizeof(smr_pss_shmem_kb_));
  }
  _has_bits_.Clear();
  _internal_metadata_.Clear<std::string>();
}
...
void ProcessStats_Process::InternalSwap(ProcessStats_Process* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(ProcessStats_Process, smr_pss_shmem_kb_)
      + sizeof(ProcessStats_Process::smr_pss_shmem_kb_)
