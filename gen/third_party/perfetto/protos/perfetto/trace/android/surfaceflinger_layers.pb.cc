...
static const ::PROTOBUF_NAMESPACE_ID::internal::EnumEntry HwcCompositionType_entries[] = {
  ...
  { {HwcCompositionType_names + 45, 17}, 5 },
  { {HwcCompositionType_names + 62, 20}, 3 },
  { {HwcCompositionType_names + 82, 20}, 0 },
};

static const int HwcCompositionType_entries_by_number[] = {
  5, // 0 -> HWC_TYPE_UNSPECIFIED
  0, // 1 -> HWC_TYPE_CLIENT
  2, // 2 -> HWC_TYPE_DEVICE
  4, // 3 -> HWC_TYPE_SOLID_COLOR
  1, // 4 -> HWC_TYPE_CURSOR
  3, // 5 -> HWC_TYPE_SIDEBAND
};
