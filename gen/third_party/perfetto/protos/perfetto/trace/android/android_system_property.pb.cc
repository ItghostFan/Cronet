...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 AndroidSystemProperty_PropertyValueDefaultTypeInternal _AndroidSystemProperty_PropertyValue_default_instance_;
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 AndroidSystemPropertyDefaultTypeInternal _AndroidSystemProperty_default_instance_;
}  // namespace protos
}  // namespace perfetto
namespace perfetto {
namespace protos {
...
class AndroidSystemProperty_PropertyValue::_Internal {
 public:
  using HasBits = decltype(std::declval<AndroidSystemProperty_PropertyValue>()._has_bits_);
