...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 AndroidCameraFrameEvent_CameraNodeProcessingDetailsDefaultTypeInternal _AndroidCameraFrameEvent_CameraNodeProcessingDetails_default_instance_;
PROTOBUF_CONSTEXPR AndroidCameraFrameEvent::AndroidCameraFrameEvent(
    ::_pbi::ConstantInitialized)
  : node_processing_details_()
  , vendor_data_(&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{})
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 AndroidCameraFrameEventDefaultTypeInternal _AndroidCameraFrameEvent_default_instance_;
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 AndroidCameraSessionStats_CameraGraph_CameraNodeDefaultTypeInternal _AndroidCameraSessionStats_CameraGraph_CameraNode_default_instance_;
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 AndroidCameraSessionStats_CameraGraph_CameraEdgeDefaultTypeInternal _AndroidCameraSessionStats_CameraGraph_CameraEdge_default_instance_;
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 AndroidCameraSessionStats_CameraGraphDefaultTypeInternal _AndroidCameraSessionStats_CameraGraph_default_instance_;
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 AndroidCameraSessionStatsDefaultTypeInternal _AndroidCameraSessionStats_default_instance_;
}  // namespace protos
}  // namespace perfetto
namespace perfetto {
namespace protos {
...
class AndroidCameraFrameEvent_CameraNodeProcessingDetails::_Internal {
 public:
  using HasBits = decltype(std::declval<AndroidCameraFrameEvent_CameraNodeProcessingDetails>()._has_bits_);
...
AndroidCameraFrameEvent_CameraNodeProcessingDetails::AndroidCameraFrameEvent_CameraNodeProcessingDetails(const AndroidCameraFrameEvent_CameraNodeProcessingDetails& from)
  ...
  ::memcpy(&node_id_, &from.node_id_,
    static_cast<size_t>(reinterpret_cast<char*>(&scheduling_latency_ns_) -
    reinterpret_cast<char*>(&node_id_)) + sizeof(scheduling_latency_ns_));
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    0, static_cast<size_t>(reinterpret_cast<char*>(&scheduling_latency_ns_) -
    reinterpret_cast<char*>(&node_id_)) + sizeof(scheduling_latency_ns_));
}
...
// @@protoc_insertion_point(message_clear_start:perfetto.protos.AndroidCameraFrameEvent.CameraNodeProcessingDetails)
  ...
  if (cached_has_bits & 0x0000000fu) {
    ::memset(&node_id_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&scheduling_latency_ns_) -
        reinterpret_cast<char*>(&node_id_)) + sizeof(scheduling_latency_ns_));
  }
  _has_bits_.Clear();
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 16)) {
          ...
          start_processing_ns_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 24)) {
          ...
          end_processing_ns_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 32)) {
          ...
          scheduling_latency_ns_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
// @@protoc_insertion_point(class_specific_merge_from_start:perfetto.protos.AndroidCameraFrameEvent.CameraNodeProcessingDetails)
  ...
  if (cached_has_bits & 0x0000000fu) {
    ...
    if (cached_has_bits & 0x00000002u) {
      start_processing_ns_ = from.start_processing_ns_;
    }
    if (cached_has_bits & 0x00000004u) {
      end_processing_ns_ = from.end_processing_ns_;
    }
    if (cached_has_bits & 0x00000008u) {
      scheduling_latency_ns_ = from.scheduling_latency_ns_;
    }
...
void AndroidCameraFrameEvent_CameraNodeProcessingDetails::InternalSwap(AndroidCameraFrameEvent_CameraNodeProcessingDetails* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(AndroidCameraFrameEvent_CameraNodeProcessingDetails, scheduling_latency_ns_)
      + sizeof(AndroidCameraFrameEvent_CameraNodeProcessingDetails::scheduling_latency_ns_)
      - PROTOBUF_FIELD_OFFSET(AndroidCameraFrameEvent_CameraNodeProcessingDetails, node_id_)>(
...
class AndroidCameraFrameEvent::_Internal {
 public:
  using HasBits = decltype(std::declval<AndroidCameraFrameEvent>()._has_bits_);
...
AndroidCameraFrameEvent::AndroidCameraFrameEvent(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::MessageLite(arena, is_message_owned),
  node_processing_details_(arena) {
  SharedCtor();
...
AndroidCameraFrameEvent::AndroidCameraFrameEvent(const AndroidCameraFrameEvent& from)
  : ::PROTOBUF_NAMESPACE_ID::MessageLite(),
      _has_bits_(from._has_bits_),
      node_processing_details_(from.node_processing_details_) {
  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
  vendor_data_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    vendor_data_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_vendor_data()) {
    vendor_data_.Set(from._internal_vendor_data(), 
      GetArenaForAllocation());
  }
  ::memcpy(&session_id_, &from.session_id_,
    static_cast<size_t>(reinterpret_cast<char*>(&vendor_data_version_) -
    reinterpret_cast<char*>(&session_id_)) + sizeof(vendor_data_version_));
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    0, static_cast<size_t>(reinterpret_cast<char*>(&vendor_data_version_) -
    reinterpret_cast<char*>(&session_id_)) + sizeof(vendor_data_version_));
}
...
// @@protoc_insertion_point(message_clear_start:perfetto.protos.AndroidCameraFrameEvent)
  ...
  cached_has_bits = _has_bits_[0];
  if (cached_has_bits & 0x00000001u) {
    vendor_data_.ClearNonDefaultToEmpty();
  }
  if (cached_has_bits & 0x000000feu) {
    ::memset(&session_id_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&capture_result_status_) -
        reinterpret_cast<char*>(&session_id_)) + sizeof(capture_result_status_));
  }
  if (cached_has_bits & 0x00007f00u) {
    ::memset(&start_of_exposure_ns_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&vendor_data_version_) -
        reinterpret_cast<char*>(&start_of_exposure_ns_)) + sizeof(vendor_data_version_));
  }
  _has_bits_.Clear();
  _internal_metadata_.Clear<std::string>();
}
    ...
    switch (tag >> 3) {
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 40)) {
          ...
          request_received_ns_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 6:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 48)) {
          ...
          request_processing_started_ns_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 7:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 56)) {
          ...
          start_of_exposure_ns_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 8:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 64)) {
          ...
          start_of_frame_ns_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 9:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 72)) {
          ...
          responses_all_sent_ns_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 11:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 88)) {
          ...
          skipped_sensor_frames_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 12:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 96)) {
          ...
          capture_intent_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 15:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 120)) {
          ...
          vendor_data_version_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
// @@protoc_insertion_point(message_byte_size_start:perfetto.protos.AndroidCameraFrameEvent)
  ...
  for (const auto& msg : this->node_processing_details_) {
    total_size +=
...
// @@protoc_insertion_point(class_specific_merge_from_start:perfetto.protos.AndroidCameraFrameEvent)
  ...
  node_processing_details_.MergeFrom(from.node_processing_details_);
  cached_has_bits = from._has_bits_[0];
  if (cached_has_bits & 0x000000ffu) {
    if (cached_has_bits & 0x00000001u) {
      _internal_set_vendor_data(from._internal_vendor_data());
    }
    if (cached_has_bits & 0x00000002u) {
    ...
    if (cached_has_bits & 0x00000010u) {
      request_received_ns_ = from.request_received_ns_;
    }
    if (cached_has_bits & 0x00000020u) {
      request_processing_started_ns_ = from.request_processing_started_ns_;
    }
    if (cached_has_bits & 0x00000040u) {
      camera_id_ = from.camera_id_;
    }
    if (cached_has_bits & 0x00000080u) {
      capture_result_status_ = from.capture_result_status_;
    }
    _has_bits_[0] |= cached_has_bits;
  }
  if (cached_has_bits & 0x00007f00u) {
    if (cached_has_bits & 0x00000100u) {
      start_of_exposure_ns_ = from.start_of_exposure_ns_;
    }
    if (cached_has_bits & 0x00000200u) {
      start_of_frame_ns_ = from.start_of_frame_ns_;
    }
    if (cached_has_bits & 0x00000400u) {
      responses_all_sent_ns_ = from.responses_all_sent_ns_;
    }
    if (cached_has_bits & 0x00000800u) {
      skipped_sensor_frames_ = from.skipped_sensor_frames_;
    }
    if (cached_has_bits & 0x00001000u) {
      capture_intent_ = from.capture_intent_;
    }
    if (cached_has_bits & 0x00002000u) {
      num_streams_ = from.num_streams_;
    }
    if (cached_has_bits & 0x00004000u) {
      vendor_data_version_ = from.vendor_data_version_;
    }
    _has_bits_[0] |= cached_has_bits;
  }
  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
...
void AndroidCameraFrameEvent::InternalSwap(AndroidCameraFrameEvent* other) {
  ...
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  swap(_has_bits_[0], other->_has_bits_[0]);
  node_processing_details_.InternalSwap(&other->node_processing_details_);
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &vendor_data_, lhs_arena,
      &other->vendor_data_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(AndroidCameraFrameEvent, vendor_data_version_)
      + sizeof(AndroidCameraFrameEvent::vendor_data_version_)
      - PROTOBUF_FIELD_OFFSET(AndroidCameraFrameEvent, session_id_)>(
...
class AndroidCameraSessionStats_CameraGraph_CameraNode::_Internal {
 public:
  using HasBits = decltype(std::declval<AndroidCameraSessionStats_CameraGraph_CameraNode>()._has_bits_);
  static void set_has_node_id(HasBits* has_bits) {
    (*has_bits)[0] |= 2u;
  }
  static void set_has_vendor_data_version(HasBits* has_bits) {
...
AndroidCameraSessionStats_CameraGraph_CameraNode::AndroidCameraSessionStats_CameraGraph_CameraNode(const AndroidCameraSessionStats_CameraGraph_CameraNode& from)
  ...
  ::memcpy(&node_id_, &from.node_id_,
    static_cast<size_t>(reinterpret_cast<char*>(&vendor_data_version_) -
    reinterpret_cast<char*>(&node_id_)) + sizeof(vendor_data_version_));
...
void AndroidCameraSessionStats_CameraGraph_CameraNode::InternalSwap(AndroidCameraSessionStats_CameraGraph_CameraNode* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(AndroidCameraSessionStats_CameraGraph_CameraNode, vendor_data_version_)
      + sizeof(AndroidCameraSessionStats_CameraGraph_CameraNode::vendor_data_version_)
      - PROTOBUF_FIELD_OFFSET(AndroidCameraSessionStats_CameraGraph_CameraNode, node_id_)>(
          reinterpret_cast<char*>(&node_id_),
          reinterpret_cast<char*>(&other->node_id_));
}
...
class AndroidCameraSessionStats_CameraGraph_CameraEdge::_Internal {
 public:
  using HasBits = decltype(std::declval<AndroidCameraSessionStats_CameraGraph_CameraEdge>()._has_bits_);
...
AndroidCameraSessionStats_CameraGraph_CameraEdge::AndroidCameraSessionStats_CameraGraph_CameraEdge(const AndroidCameraSessionStats_CameraGraph_CameraEdge& from)
  ...
  ::memcpy(&output_node_id_, &from.output_node_id_,
    static_cast<size_t>(reinterpret_cast<char*>(&vendor_data_version_) -
    reinterpret_cast<char*>(&output_node_id_)) + sizeof(vendor_data_version_));
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&output_node_id_) - reinterpret_cast<char*>(this)),
    0, static_cast<size_t>(reinterpret_cast<char*>(&vendor_data_version_) -
    reinterpret_cast<char*>(&output_node_id_)) + sizeof(vendor_data_version_));
}
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 8)) {
          ...
          output_node_id_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 16)) {
          ...
          output_id_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 24)) {
          ...
          input_node_id_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 32)) {
          ...
          input_id_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
// @@protoc_insertion_point(class_specific_merge_from_start:perfetto.protos.AndroidCameraSessionStats.CameraGraph.CameraEdge)
  ...
  if (cached_has_bits & 0x0000003fu) {
    ...
    if (cached_has_bits & 0x00000004u) {
      output_id_ = from.output_id_;
    }
    if (cached_has_bits & 0x00000008u) {
      input_node_id_ = from.input_node_id_;
    }
    if (cached_has_bits & 0x00000010u) {
      input_id_ = from.input_id_;
    }
    if (cached_has_bits & 0x00000020u) {
      vendor_data_version_ = from.vendor_data_version_;
    }
...
void AndroidCameraSessionStats_CameraGraph_CameraEdge::InternalSwap(AndroidCameraSessionStats_CameraGraph_CameraEdge* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(AndroidCameraSessionStats_CameraGraph_CameraEdge, vendor_data_version_)
      + sizeof(AndroidCameraSessionStats_CameraGraph_CameraEdge::vendor_data_version_)
      - PROTOBUF_FIELD_OFFSET(AndroidCameraSessionStats_CameraGraph_CameraEdge, output_node_id_)>(
          reinterpret_cast<char*>(&output_node_id_),
          reinterpret_cast<char*>(&other->output_node_id_));
}
...
class AndroidCameraSessionStats::_Internal {
 public:
  using HasBits = decltype(std::declval<AndroidCameraSessionStats>()._has_bits_);
  static void set_has_session_id(HasBits* has_bits) {
    (*has_bits)[0] |= 2u;
  }
...
AndroidCameraSessionStats::AndroidCameraSessionStats(const AndroidCameraSessionStats& from)
  ...
  if (from._internal_has_graph()) {
    graph_ = new ::perfetto::protos::AndroidCameraSessionStats_CameraGraph(*from.graph_);
  } else {
    graph_ = nullptr;
  }
  session_id_ = from.session_id_;
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    reinterpret_cast<char*>(&graph_)) + sizeof(session_id_));
}
...
// @@protoc_insertion_point(class_specific_merge_from_start:perfetto.protos.AndroidCameraSessionStats)
  ...
  if (cached_has_bits & 0x00000003u) {
    if (cached_has_bits & 0x00000001u) {
      _internal_mutable_graph()->::perfetto::protos::AndroidCameraSessionStats_CameraGraph::MergeFrom(from._internal_graph());
    }
    if (cached_has_bits & 0x00000002u) {
      session_id_ = from.session_id_;
    }
...
void AndroidCameraSessionStats::InternalSwap(AndroidCameraSessionStats* other) {
  ...
  swap(_has_bits_[0], other->_has_bits_[0]);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(AndroidCameraSessionStats, session_id_)
      + sizeof(AndroidCameraSessionStats::session_id_)
      - PROTOBUF_FIELD_OFFSET(AndroidCameraSessionStats, graph_)>(
