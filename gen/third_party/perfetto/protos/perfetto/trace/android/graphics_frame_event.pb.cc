...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 GraphicsFrameEvent_BufferEventDefaultTypeInternal _GraphicsFrameEvent_BufferEvent_default_instance_;
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 GraphicsFrameEventDefaultTypeInternal _GraphicsFrameEvent_default_instance_;
}  // namespace protos
}  // namespace perfetto
namespace perfetto {
namespace protos {
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    0, static_cast<size_t>(reinterpret_cast<char*>(&buffer_id_) -
    reinterpret_cast<char*>(&frame_number_)) + sizeof(buffer_id_));
}
    ...
    switch (tag >> 3) {
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 40)) {
          ...
          buffer_id_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
void GraphicsFrameEvent_BufferEvent::InternalSwap(GraphicsFrameEvent_BufferEvent* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(GraphicsFrameEvent_BufferEvent, buffer_id_)
      + sizeof(GraphicsFrameEvent_BufferEvent::buffer_id_)
      - PROTOBUF_FIELD_OFFSET(GraphicsFrameEvent_BufferEvent, frame_number_)>(
...
// @@protoc_insertion_point(class_specific_merge_from_start:perfetto.protos.GraphicsFrameEvent)
  ...
  if (from._internal_has_buffer_event()) {
    _internal_mutable_buffer_event()->::perfetto::protos::GraphicsFrameEvent_BufferEvent::MergeFrom(from._internal_buffer_event());
  }
  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
}
