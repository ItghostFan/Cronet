...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 InodeFileMap_EntryDefaultTypeInternal _InodeFileMap_Entry_default_instance_;
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 InodeFileMapDefaultTypeInternal _InodeFileMap_default_instance_;
}  // namespace protos
}  // namespace perfetto
namespace perfetto {
namespace protos {
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&inode_number_) - reinterpret_cast<char*>(this)),
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 8)) {
          ...
          inode_number_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
void InodeFileMap_Entry::InternalSwap(InodeFileMap_Entry* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(InodeFileMap_Entry, type_)
      + sizeof(InodeFileMap_Entry::type_)
      - PROTOBUF_FIELD_OFFSET(InodeFileMap_Entry, inode_number_)>(
          reinterpret_cast<char*>(&inode_number_),
          reinterpret_cast<char*>(&other->inode_number_));
}
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 8)) {
          ...
          block_device_id_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
// @@protoc_insertion_point(message_byte_size_start:perfetto.protos.InodeFileMap)
  ...
  // repeated string mount_points = 2;
  total_size += 1 *
      ::PROTOBUF_NAMESPACE_ID::internal::FromIntSize(mount_points_.size());
  for (int i = 0, n = mount_points_.size(); i < n; i++) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::StringSize(
      mount_points_.Get(i));
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:perfetto.protos.InodeFileMap)
  ...
  if (from._internal_has_block_device_id()) {
    _internal_set_block_device_id(from._internal_block_device_id());
  }
  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
}
...
void InodeFileMap::InternalSwap(InodeFileMap* other) {
  ...
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  swap(_has_bits_[0], other->_has_bits_[0]);
  mount_points_.InternalSwap(&other->mount_points_);
