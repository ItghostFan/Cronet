...
PROTOBUF_CONSTEXPR EntityStateResidency_PowerEntityState::EntityStateResidency_PowerEntityState(
  ...
  , state_name_(&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{})
  , entity_index_(0)
  , state_index_(0){}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 EntityStateResidency_PowerEntityStateDefaultTypeInternal _EntityStateResidency_PowerEntityState_default_instance_;
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 EntityStateResidency_StateResidencyDefaultTypeInternal _EntityStateResidency_StateResidency_default_instance_;
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 EntityStateResidencyDefaultTypeInternal _EntityStateResidency_default_instance_;
}  // namespace protos
}  // namespace perfetto
namespace perfetto {
namespace protos {
...
class EntityStateResidency_PowerEntityState::_Internal {
 public:
  using HasBits = decltype(std::declval<EntityStateResidency_PowerEntityState>()._has_bits_);
...
EntityStateResidency_PowerEntityState::EntityStateResidency_PowerEntityState(const EntityStateResidency_PowerEntityState& from)
  ...
  state_name_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    state_name_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_state_name()) {
    state_name_.Set(from._internal_state_name(), 
      GetArenaForAllocation());
  }
  ::memcpy(&entity_index_, &from.entity_index_,
    static_cast<size_t>(reinterpret_cast<char*>(&state_index_) -
    reinterpret_cast<char*>(&entity_index_)) + sizeof(state_index_));
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    0, static_cast<size_t>(reinterpret_cast<char*>(&state_index_) -
    reinterpret_cast<char*>(&entity_index_)) + sizeof(state_index_));
}
...
// @@protoc_insertion_point(message_clear_start:perfetto.protos.EntityStateResidency.PowerEntityState)
  ...
  if (cached_has_bits & 0x0000000cu) {
    ::memset(&entity_index_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&state_index_) -
        reinterpret_cast<char*>(&entity_index_)) + sizeof(state_index_));
  }
  _has_bits_.Clear();
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 16)) {
          ...
          state_index_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
// @@protoc_insertion_point(class_specific_merge_from_start:perfetto.protos.EntityStateResidency.PowerEntityState)
  ...
  if (cached_has_bits & 0x0000000fu) {
    ...
    if (cached_has_bits & 0x00000008u) {
      state_index_ = from.state_index_;
    }
...
void EntityStateResidency_PowerEntityState::InternalSwap(EntityStateResidency_PowerEntityState* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(EntityStateResidency_PowerEntityState, state_index_)
      + sizeof(EntityStateResidency_PowerEntityState::state_index_)
      - PROTOBUF_FIELD_OFFSET(EntityStateResidency_PowerEntityState, entity_index_)>(
...
class EntityStateResidency_StateResidency::_Internal {
 public:
  using HasBits = decltype(std::declval<EntityStateResidency_StateResidency>()._has_bits_);
  static void set_has_entity_index(HasBits* has_bits) {
    (*has_bits)[0] |= 1u;
  }
  static void set_has_state_index(HasBits* has_bits) {
...
EntityStateResidency_StateResidency::EntityStateResidency_StateResidency(const EntityStateResidency_StateResidency& from)
  ...
  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
  ::memcpy(&entity_index_, &from.entity_index_,
    static_cast<size_t>(reinterpret_cast<char*>(&last_entry_timestamp_ms_) -
    reinterpret_cast<char*>(&entity_index_)) + sizeof(last_entry_timestamp_ms_));
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&entity_index_) - reinterpret_cast<char*>(this)),
    0, static_cast<size_t>(reinterpret_cast<char*>(&last_entry_timestamp_ms_) -
    reinterpret_cast<char*>(&entity_index_)) + sizeof(last_entry_timestamp_ms_));
}
...
// @@protoc_insertion_point(message_clear_start:perfetto.protos.EntityStateResidency.StateResidency)
  ...
  if (cached_has_bits & 0x0000001fu) {
    ::memset(&entity_index_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&last_entry_timestamp_ms_) -
        reinterpret_cast<char*>(&entity_index_)) + sizeof(last_entry_timestamp_ms_));
  }
  _has_bits_.Clear();
  _internal_metadata_.Clear<std::string>();
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 24)) {
          ...
          total_time_in_state_ms_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 32)) {
          ...
          total_state_entry_count_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 40)) {
          ...
          last_entry_timestamp_ms_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
void EntityStateResidency_StateResidency::InternalSwap(EntityStateResidency_StateResidency* other) {
  ...
  swap(_has_bits_[0], other->_has_bits_[0]);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(EntityStateResidency_StateResidency, last_entry_timestamp_ms_)
      + sizeof(EntityStateResidency_StateResidency::last_entry_timestamp_ms_)
      - PROTOBUF_FIELD_OFFSET(EntityStateResidency_StateResidency, entity_index_)>(
          reinterpret_cast<char*>(&entity_index_),
          reinterpret_cast<char*>(&other->entity_index_));
}
...
EntityStateResidency::EntityStateResidency(const EntityStateResidency& from)
  : ::PROTOBUF_NAMESPACE_ID::MessageLite(),
      power_entity_state_(from.power_entity_state_),
      residency_(from.residency_) {
  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
...
// @@protoc_insertion_point(message_byte_size_start:perfetto.protos.EntityStateResidency)
  ...
  for (const auto& msg : this->power_entity_state_) {
    total_size +=
  ...
  for (const auto& msg : this->residency_) {
    total_size +=
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::MessageSize(msg);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:perfetto.protos.EntityStateResidency)
  ...
  power_entity_state_.MergeFrom(from.power_entity_state_);
  residency_.MergeFrom(from.residency_);
  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
}
...
void EntityStateResidency::InternalSwap(EntityStateResidency* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  power_entity_state_.InternalSwap(&other->power_entity_state_);
  residency_.InternalSwap(&other->residency_);
}
