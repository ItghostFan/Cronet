...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 AndroidEnergyEstimationBreakdown_EnergyUidBreakdownDefaultTypeInternal _AndroidEnergyEstimationBreakdown_EnergyUidBreakdown_default_instance_;
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 AndroidEnergyEstimationBreakdownDefaultTypeInternal _AndroidEnergyEstimationBreakdown_default_instance_;
}  // namespace protos
}  // namespace perfetto
namespace perfetto {
namespace protos {
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&energy_uws_) - reinterpret_cast<char*>(this)),
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 16)) {
          ...
          energy_uws_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
void AndroidEnergyEstimationBreakdown_EnergyUidBreakdown::InternalSwap(AndroidEnergyEstimationBreakdown_EnergyUidBreakdown* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(AndroidEnergyEstimationBreakdown_EnergyUidBreakdown, uid_)
      + sizeof(AndroidEnergyEstimationBreakdown_EnergyUidBreakdown::uid_)
      - PROTOBUF_FIELD_OFFSET(AndroidEnergyEstimationBreakdown_EnergyUidBreakdown, energy_uws_)>(
          reinterpret_cast<char*>(&energy_uws_),
          reinterpret_cast<char*>(&other->energy_uws_));
}
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&energy_consumer_descriptor_) - reinterpret_cast<char*>(this)),
    0, static_cast<size_t>(reinterpret_cast<char*>(&energy_consumer_id_) -
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 16)) {
          ...
          energy_consumer_id_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
// @@protoc_insertion_point(message_byte_size_start:perfetto.protos.AndroidEnergyEstimationBreakdown)
  ...
  for (const auto& msg : this->per_uid_breakdown_) {
    total_size +=
...
// @@protoc_insertion_point(class_specific_merge_from_start:perfetto.protos.AndroidEnergyEstimationBreakdown)
  ...
  if (cached_has_bits & 0x00000007u) {
    if (cached_has_bits & 0x00000001u) {
      _internal_mutable_energy_consumer_descriptor()->::perfetto::protos::AndroidEnergyConsumerDescriptor::MergeFrom(from._internal_energy_consumer_descriptor());
    }
    if (cached_has_bits & 0x00000002u) {
      energy_uws_ = from.energy_uws_;
    }
...
void AndroidEnergyEstimationBreakdown::InternalSwap(AndroidEnergyEstimationBreakdown* other) {
  ...
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  swap(_has_bits_[0], other->_has_bits_[0]);
  per_uid_breakdown_.InternalSwap(&other->per_uid_breakdown_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      ...
      - PROTOBUF_FIELD_OFFSET(AndroidEnergyEstimationBreakdown, energy_consumer_descriptor_)>(
          reinterpret_cast<char*>(&energy_consumer_descriptor_),
          reinterpret_cast<char*>(&other->energy_consumer_descriptor_));
}
