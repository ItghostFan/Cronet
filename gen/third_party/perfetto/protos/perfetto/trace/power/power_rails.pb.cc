...
PROTOBUF_CONSTEXPR PowerRails_RailDescriptor::PowerRails_RailDescriptor(
  ...
  : rail_name_(&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{})
  , subsys_name_(&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{})
  , index_(0u)
  , sampling_rate_(0u){}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 PowerRails_RailDescriptorDefaultTypeInternal _PowerRails_RailDescriptor_default_instance_;
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 PowerRails_EnergyDataDefaultTypeInternal _PowerRails_EnergyData_default_instance_;
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 PowerRailsDefaultTypeInternal _PowerRails_default_instance_;
}  // namespace protos
}  // namespace perfetto
namespace perfetto {
namespace protos {
...
// @@protoc_insertion_point(message_clear_start:perfetto.protos.PowerRails.RailDescriptor)
  ...
  if (cached_has_bits & 0x00000003u) {
    if (cached_has_bits & 0x00000001u) {
      rail_name_.ClearNonDefaultToEmpty();
    }
    if (cached_has_bits & 0x00000002u) {
      subsys_name_.ClearNonDefaultToEmpty();
    }
  }
    ...
    switch (tag >> 3) {
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 32)) {
          ...
          sampling_rate_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
// @@protoc_insertion_point(class_specific_merge_from_start:perfetto.protos.PowerRails.RailDescriptor)
  ...
  if (cached_has_bits & 0x0000000fu) {
    if (cached_has_bits & 0x00000001u) {
      _internal_set_rail_name(from._internal_rail_name());
    }
    if (cached_has_bits & 0x00000002u) {
      _internal_set_subsys_name(from._internal_subsys_name());
    }
    if (cached_has_bits & 0x00000004u) {
      index_ = from.index_;
    }
...
void PowerRails_RailDescriptor::InternalSwap(PowerRails_RailDescriptor* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &rail_name_, lhs_arena,
      &other->rail_name_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &subsys_name_, lhs_arena,
      &other->subsys_name_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(PowerRails_RailDescriptor, sampling_rate_)
      + sizeof(PowerRails_RailDescriptor::sampling_rate_)
      - PROTOBUF_FIELD_OFFSET(PowerRails_RailDescriptor, index_)>(
...
void PowerRails_EnergyData::InternalSwap(PowerRails_EnergyData* other) {
  ...
  swap(_has_bits_[0], other->_has_bits_[0]);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(PowerRails_EnergyData, index_)
      + sizeof(PowerRails_EnergyData::index_)
      - PROTOBUF_FIELD_OFFSET(PowerRails_EnergyData, timestamp_ms_)>(
...
// @@protoc_insertion_point(message_byte_size_start:perfetto.protos.PowerRails)
  ...
  for (const auto& msg : this->rail_descriptor_) {
    total_size +=
  ...
  for (const auto& msg : this->energy_data_) {
    total_size +=
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::MessageSize(msg);
  }
...
void PowerRails::InternalSwap(PowerRails* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  rail_descriptor_.InternalSwap(&other->rail_descriptor_);
  energy_data_.InternalSwap(&other->energy_data_);
}
