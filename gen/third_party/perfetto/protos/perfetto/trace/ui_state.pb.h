...
inline void UiState_HighlightProcess::set_cmdline(ArgT0&& arg0, ArgT... args) {
  if (!_internal_has_cmdline()) {
    clear_selector();
    set_has_cmdline();
    selector_.cmdline_.InitDefault();
  }
  selector_.cmdline_.Set( static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void UiState_HighlightProcess::_internal_set_cmdline(const std::string& value) {
  ...
  selector_.cmdline_.Set(value, GetArenaForAllocation());
}
inline std::string* UiState_HighlightProcess::_internal_mutable_cmdline() {
  ...
  return selector_.cmdline_.Mutable(      GetArenaForAllocation());
}
inline std::string* UiState_HighlightProcess::release_cmdline() {
  ...
  if (_internal_has_cmdline()) {
    clear_has_selector();
    return selector_.cmdline_.Release();
  } else {
    return nullptr;
  }
}
inline void UiState_HighlightProcess::set_allocated_cmdline(std::string* cmdline) {
  ...
  if (cmdline != nullptr) {
    set_has_cmdline();
    selector_.cmdline_.InitAllocated(cmdline, GetArenaForAllocation());
  }
...
inline bool UiState::_internal_has_highlight_process() const {
  ...
  PROTOBUF_ASSUME(!value || highlight_process_ != nullptr);
  return value;
}
...
inline void UiState::unsafe_arena_set_allocated_highlight_process(
  ...
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(highlight_process_);
  }
