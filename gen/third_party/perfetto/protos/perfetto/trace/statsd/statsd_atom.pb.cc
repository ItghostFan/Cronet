...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 AtomDefaultTypeInternal _Atom_default_instance_;
...
StatsdAtom::StatsdAtom(const StatsdAtom& from)
  : ::PROTOBUF_NAMESPACE_ID::MessageLite(),
      atom_(from.atom_),
      timestamp_nanos_(from.timestamp_nanos_) {
  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
...
// @@protoc_insertion_point(message_byte_size_start:perfetto.protos.StatsdAtom)
  ...
  // repeated int64 timestamp_nanos = 2;
  {
    size_t data_size = ::_pbi::WireFormatLite::
      Int64Size(this->timestamp_nanos_);
    total_size += 1 *
...
// @@protoc_insertion_point(class_specific_merge_from_start:perfetto.protos.StatsdAtom)
  ...
  timestamp_nanos_.MergeFrom(from.timestamp_nanos_);
  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
}
...
void StatsdAtom::InternalSwap(StatsdAtom* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  atom_.InternalSwap(&other->atom_);
  timestamp_nanos_.InternalSwap(&other->timestamp_nanos_);
}
