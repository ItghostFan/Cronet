...
void SdeSdeEvtlogFtraceEvent::set_evtlog_tag(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 evtlog_tag_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* SdeSdeEvtlogFtraceEvent::release_evtlog_tag() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  auto* p = evtlog_tag_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (evtlog_tag_.IsDefault()) {
...
inline void SdeSdeEvtlogFtraceEvent::set_allocated_evtlog_tag(std::string* evtlog_tag) {
  ...
  evtlog_tag_.SetAllocated(evtlog_tag, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (evtlog_tag_.IsDefault()) {
    evtlog_tag_.Set("", GetArenaForAllocation());
  }
