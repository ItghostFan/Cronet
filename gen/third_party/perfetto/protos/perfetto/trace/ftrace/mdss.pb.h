...
void MdpTraceCounterFtraceEvent::set_counter_name(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 counter_name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* MdpTraceCounterFtraceEvent::release_counter_name() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  auto* p = counter_name_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (counter_name_.IsDefault()) {
...
inline void MdpTraceCounterFtraceEvent::set_allocated_counter_name(std::string* counter_name) {
  ...
  counter_name_.SetAllocated(counter_name, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (counter_name_.IsDefault()) {
    counter_name_.Set("", GetArenaForAllocation());
  }
