...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 FastrpcDmaStatFtraceEventDefaultTypeInternal _FastrpcDmaStatFtraceEvent_default_instance_;
}  // namespace protos
}  // namespace perfetto
namespace perfetto {
namespace protos {
...
void FastrpcDmaStatFtraceEvent::InternalSwap(FastrpcDmaStatFtraceEvent* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(FastrpcDmaStatFtraceEvent, cid_)
      + sizeof(FastrpcDmaStatFtraceEvent::cid_)
      - PROTOBUF_FIELD_OFFSET(FastrpcDmaStatFtraceEvent, len_)>(
