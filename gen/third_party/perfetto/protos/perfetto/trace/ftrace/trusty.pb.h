...
void TrustyIpcHandleEventFtraceEvent::set_srv_name(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 srv_name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* TrustyIpcHandleEventFtraceEvent::release_srv_name() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  auto* p = srv_name_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (srv_name_.IsDefault()) {
...
inline void TrustyIpcHandleEventFtraceEvent::set_allocated_srv_name(std::string* srv_name) {
  ...
  srv_name_.SetAllocated(srv_name, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (srv_name_.IsDefault()) {
    srv_name_.Set("", GetArenaForAllocation());
  }
