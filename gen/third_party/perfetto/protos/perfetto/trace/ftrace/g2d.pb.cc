...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 G2dTracingMarkWriteFtraceEventDefaultTypeInternal _G2dTracingMarkWriteFtraceEvent_default_instance_;
}  // namespace protos
}  // namespace perfetto
namespace perfetto {
namespace protos {
...
void G2dTracingMarkWriteFtraceEvent::InternalSwap(G2dTracingMarkWriteFtraceEvent* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(G2dTracingMarkWriteFtraceEvent, value_)
      + sizeof(G2dTracingMarkWriteFtraceEvent::value_)
      - PROTOBUF_FIELD_OFFSET(G2dTracingMarkWriteFtraceEvent, pid_)>(
