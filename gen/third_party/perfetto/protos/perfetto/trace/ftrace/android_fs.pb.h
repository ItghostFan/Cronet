...
void AndroidFsDatareadStartFtraceEvent::set_cmdline(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 cmdline_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void AndroidFsDatareadStartFtraceEvent::_internal_set_cmdline(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  cmdline_.Set(value, GetArenaForAllocation());
}
inline std::string* AndroidFsDatareadStartFtraceEvent::_internal_mutable_cmdline() {
  _has_bits_[0] |= 0x00000001u;
  return cmdline_.Mutable(GetArenaForAllocation());
}
inline std::string* AndroidFsDatareadStartFtraceEvent::release_cmdline() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  auto* p = cmdline_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (cmdline_.IsDefault()) {
...
inline void AndroidFsDatareadStartFtraceEvent::set_allocated_cmdline(std::string* cmdline) {
  ...
  cmdline_.SetAllocated(cmdline, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (cmdline_.IsDefault()) {
    cmdline_.Set("", GetArenaForAllocation());
  }
...
void AndroidFsDatareadStartFtraceEvent::set_pathbuf(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000002u;
 pathbuf_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void AndroidFsDatareadStartFtraceEvent::_internal_set_pathbuf(const std::string& value) {
  _has_bits_[0] |= 0x00000002u;
  pathbuf_.Set(value, GetArenaForAllocation());
}
inline std::string* AndroidFsDatareadStartFtraceEvent::_internal_mutable_pathbuf() {
  _has_bits_[0] |= 0x00000002u;
  return pathbuf_.Mutable(GetArenaForAllocation());
}
inline std::string* AndroidFsDatareadStartFtraceEvent::release_pathbuf() {
  ...
  _has_bits_[0] &= ~0x00000002u;
  auto* p = pathbuf_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (pathbuf_.IsDefault()) {
...
inline void AndroidFsDatareadStartFtraceEvent::set_allocated_pathbuf(std::string* pathbuf) {
  ...
  pathbuf_.SetAllocated(pathbuf, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (pathbuf_.IsDefault()) {
    pathbuf_.Set("", GetArenaForAllocation());
  }
