...
void TrapRegFtraceEvent::set_fn(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 fn_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void TrapRegFtraceEvent::_internal_set_fn(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  fn_.Set(value, GetArenaForAllocation());
}
inline std::string* TrapRegFtraceEvent::_internal_mutable_fn() {
  _has_bits_[0] |= 0x00000001u;
  return fn_.Mutable(GetArenaForAllocation());
}
...
inline void TrapRegFtraceEvent::set_allocated_fn(std::string* fn) {
  ...
  fn_.SetAllocated(fn, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (fn_.IsDefault()) {
    fn_.Set("", GetArenaForAllocation());
  }
