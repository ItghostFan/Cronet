...
void CgroupAttachTaskFtraceEvent::set_cname(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000002u;
 cname_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void CgroupAttachTaskFtraceEvent::_internal_set_cname(const std::string& value) {
  _has_bits_[0] |= 0x00000002u;
  cname_.Set(value, GetArenaForAllocation());
}
inline std::string* CgroupAttachTaskFtraceEvent::_internal_mutable_cname() {
  _has_bits_[0] |= 0x00000002u;
  return cname_.Mutable(GetArenaForAllocation());
}
...
inline void CgroupAttachTaskFtraceEvent::set_allocated_cname(std::string* cname) {
  ...
  cname_.SetAllocated(cname, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (cname_.IsDefault()) {
    cname_.Set("", GetArenaForAllocation());
  }
