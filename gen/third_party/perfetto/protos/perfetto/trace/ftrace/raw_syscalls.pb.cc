...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 SysEnterFtraceEventDefaultTypeInternal _SysEnterFtraceEvent_default_instance_;
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 SysExitFtraceEventDefaultTypeInternal _SysExitFtraceEvent_default_instance_;
}  // namespace protos
}  // namespace perfetto
namespace perfetto {
namespace protos {
...
void SysExitFtraceEvent::InternalSwap(SysExitFtraceEvent* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(SysExitFtraceEvent, ret_)
      + sizeof(SysExitFtraceEvent::ret_)
      - PROTOBUF_FIELD_OFFSET(SysExitFtraceEvent, id_)>(
