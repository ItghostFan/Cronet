...
void UfshcdCommandFtraceEvent::set_dev_name(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 dev_name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void UfshcdCommandFtraceEvent::_internal_set_dev_name(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  dev_name_.Set(value, GetArenaForAllocation());
}
inline std::string* UfshcdCommandFtraceEvent::_internal_mutable_dev_name() {
  _has_bits_[0] |= 0x00000001u;
  return dev_name_.Mutable(GetArenaForAllocation());
}
inline std::string* UfshcdCommandFtraceEvent::release_dev_name() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  auto* p = dev_name_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (dev_name_.IsDefault()) {
...
inline void UfshcdCommandFtraceEvent::set_allocated_dev_name(std::string* dev_name) {
  ...
  dev_name_.SetAllocated(dev_name, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (dev_name_.IsDefault()) {
    dev_name_.Set("", GetArenaForAllocation());
  }
