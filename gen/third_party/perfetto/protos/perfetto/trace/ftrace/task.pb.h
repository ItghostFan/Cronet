...
void TaskRenameFtraceEvent::set_oldcomm(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 oldcomm_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void TaskRenameFtraceEvent::_internal_set_oldcomm(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  oldcomm_.Set(value, GetArenaForAllocation());
}
inline std::string* TaskRenameFtraceEvent::_internal_mutable_oldcomm() {
  _has_bits_[0] |= 0x00000001u;
  return oldcomm_.Mutable(GetArenaForAllocation());
}
inline std::string* TaskRenameFtraceEvent::release_oldcomm() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  auto* p = oldcomm_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (oldcomm_.IsDefault()) {
...
inline void TaskRenameFtraceEvent::set_allocated_oldcomm(std::string* oldcomm) {
  ...
  oldcomm_.SetAllocated(oldcomm, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (oldcomm_.IsDefault()) {
    oldcomm_.Set("", GetArenaForAllocation());
  }
...
void TaskRenameFtraceEvent::set_newcomm(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000002u;
 newcomm_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void TaskRenameFtraceEvent::_internal_set_newcomm(const std::string& value) {
  _has_bits_[0] |= 0x00000002u;
  newcomm_.Set(value, GetArenaForAllocation());
}
inline std::string* TaskRenameFtraceEvent::_internal_mutable_newcomm() {
  _has_bits_[0] |= 0x00000002u;
  return newcomm_.Mutable(GetArenaForAllocation());
}
inline std::string* TaskRenameFtraceEvent::release_newcomm() {
  ...
  _has_bits_[0] &= ~0x00000002u;
  auto* p = newcomm_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (newcomm_.IsDefault()) {
...
inline void TaskRenameFtraceEvent::set_allocated_newcomm(std::string* newcomm) {
  ...
  newcomm_.SetAllocated(newcomm, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (newcomm_.IsDefault()) {
    newcomm_.Set("", GetArenaForAllocation());
  }
