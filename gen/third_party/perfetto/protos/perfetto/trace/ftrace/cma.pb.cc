...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 CmaAllocStartFtraceEventDefaultTypeInternal _CmaAllocStartFtraceEvent_default_instance_;
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 CmaAllocInfoFtraceEventDefaultTypeInternal _CmaAllocInfoFtraceEvent_default_instance_;
}  // namespace protos
}  // namespace perfetto
namespace perfetto {
namespace protos {
...
class CmaAllocStartFtraceEvent::_Internal {
 public:
  using HasBits = decltype(std::declval<CmaAllocStartFtraceEvent>()._has_bits_);
...
CmaAllocStartFtraceEvent::CmaAllocStartFtraceEvent(const CmaAllocStartFtraceEvent& from)
  ...
  ::memcpy(&align_, &from.align_,
    ...
    reinterpret_cast<char*>(&align_)) + sizeof(count_));
...
void CmaAllocStartFtraceEvent::InternalSwap(CmaAllocStartFtraceEvent* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(CmaAllocStartFtraceEvent, count_)
      + sizeof(CmaAllocStartFtraceEvent::count_)
      - PROTOBUF_FIELD_OFFSET(CmaAllocStartFtraceEvent, align_)>(
...
class CmaAllocInfoFtraceEvent::_Internal {
 public:
  using HasBits = decltype(std::declval<CmaAllocInfoFtraceEvent>()._has_bits_);
  static void set_has_align(HasBits* has_bits) {
    (*has_bits)[0] |= 2u;
  }
  static void set_has_count(HasBits* has_bits) {
...
CmaAllocInfoFtraceEvent::CmaAllocInfoFtraceEvent(const CmaAllocInfoFtraceEvent& from)
  ...
  ::memcpy(&align_, &from.align_,
    static_cast<size_t>(reinterpret_cast<char*>(&err_test_) -
    reinterpret_cast<char*>(&align_)) + sizeof(err_test_));
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&align_) - reinterpret_cast<char*>(this)),
    0, static_cast<size_t>(reinterpret_cast<char*>(&err_test_) -
    reinterpret_cast<char*>(&align_)) + sizeof(err_test_));
}
...
// @@protoc_insertion_point(message_clear_start:perfetto.protos.CmaAllocInfoFtraceEvent)
  ...
  if (cached_has_bits & 0x000000feu) {
    ::memset(&align_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&nr_reclaimed_) -
        reinterpret_cast<char*>(&align_)) + sizeof(nr_reclaimed_));
  }
  if (cached_has_bits & 0x00000300u) {
    ::memset(&pfn_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&err_test_) -
        reinterpret_cast<char*>(&pfn_)) + sizeof(err_test_));
  }
  _has_bits_.Clear();
  _internal_metadata_.Clear<std::string>();
}
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 24)) {
          ...
          err_iso_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 32)) {
          ...
          err_mig_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 40)) {
          ...
          err_test_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 7:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 56)) {
          ...
          nr_mapped_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
// @@protoc_insertion_point(class_specific_merge_from_start:perfetto.protos.CmaAllocInfoFtraceEvent)
  ...
  if (cached_has_bits & 0x000000ffu) {
    ...
    if (cached_has_bits & 0x00000008u) {
      err_iso_ = from.err_iso_;
    }
    if (cached_has_bits & 0x00000010u) {
      err_mig_ = from.err_mig_;
    }
    if (cached_has_bits & 0x00000020u) {
      nr_mapped_ = from.nr_mapped_;
    }
    if (cached_has_bits & 0x00000040u) {
...
void CmaAllocInfoFtraceEvent::InternalSwap(CmaAllocInfoFtraceEvent* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(CmaAllocInfoFtraceEvent, err_test_)
      + sizeof(CmaAllocInfoFtraceEvent::err_test_)
      - PROTOBUF_FIELD_OFFSET(CmaAllocInfoFtraceEvent, align_)>(
          reinterpret_cast<char*>(&align_),
          reinterpret_cast<char*>(&other->align_));
}
