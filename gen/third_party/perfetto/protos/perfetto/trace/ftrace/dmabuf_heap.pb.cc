...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 DmaHeapStatFtraceEventDefaultTypeInternal _DmaHeapStatFtraceEvent_default_instance_;
}  // namespace protos
}  // namespace perfetto
namespace perfetto {
namespace protos {
...
void DmaHeapStatFtraceEvent::InternalSwap(DmaHeapStatFtraceEvent* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(DmaHeapStatFtraceEvent, total_allocated_)
      + sizeof(DmaHeapStatFtraceEvent::total_allocated_)
      - PROTOBUF_FIELD_OFFSET(DmaHeapStatFtraceEvent, inode_)>(
