...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 DrmSchedJobFtraceEventDefaultTypeInternal _DrmSchedJobFtraceEvent_default_instance_;
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 DrmRunJobFtraceEventDefaultTypeInternal _DrmRunJobFtraceEvent_default_instance_;
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 DrmSchedProcessJobFtraceEventDefaultTypeInternal _DrmSchedProcessJobFtraceEvent_default_instance_;
}  // namespace protos
}  // namespace perfetto
namespace perfetto {
namespace protos {
...
class DrmSchedJobFtraceEvent::_Internal {
 public:
  using HasBits = decltype(std::declval<DrmSchedJobFtraceEvent>()._has_bits_);
...
DrmSchedJobFtraceEvent::DrmSchedJobFtraceEvent(const DrmSchedJobFtraceEvent& from)
  ...
  ::memcpy(&entity_, &from.entity_,
    static_cast<size_t>(reinterpret_cast<char*>(&job_count_) -
    reinterpret_cast<char*>(&entity_)) + sizeof(job_count_));
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    0, static_cast<size_t>(reinterpret_cast<char*>(&job_count_) -
    reinterpret_cast<char*>(&entity_)) + sizeof(job_count_));
}
...
// @@protoc_insertion_point(message_clear_start:perfetto.protos.DrmSchedJobFtraceEvent)
  ...
  if (cached_has_bits & 0x0000003eu) {
    ::memset(&entity_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&job_count_) -
        reinterpret_cast<char*>(&entity_)) + sizeof(job_count_));
  }
  _has_bits_.Clear();
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 16)) {
          ...
          fence_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 24)) {
          ...
          hw_job_count_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 40)) {
          ...
          job_count_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
// @@protoc_insertion_point(class_specific_merge_from_start:perfetto.protos.DrmSchedJobFtraceEvent)
  ...
  if (cached_has_bits & 0x0000003fu) {
    ...
    if (cached_has_bits & 0x00000010u) {
      hw_job_count_ = from.hw_job_count_;
    }
    if (cached_has_bits & 0x00000020u) {
      job_count_ = from.job_count_;
    }
...
void DrmSchedJobFtraceEvent::InternalSwap(DrmSchedJobFtraceEvent* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(DrmSchedJobFtraceEvent, job_count_)
      + sizeof(DrmSchedJobFtraceEvent::job_count_)
      - PROTOBUF_FIELD_OFFSET(DrmSchedJobFtraceEvent, entity_)>(
...
class DrmRunJobFtraceEvent::_Internal {
 public:
  using HasBits = decltype(std::declval<DrmRunJobFtraceEvent>()._has_bits_);
  static void set_has_entity(HasBits* has_bits) {
    (*has_bits)[0] |= 2u;
  }
  static void set_has_fence(HasBits* has_bits) {
...
void DrmRunJobFtraceEvent::InternalSwap(DrmRunJobFtraceEvent* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(DrmRunJobFtraceEvent, job_count_)
      + sizeof(DrmRunJobFtraceEvent::job_count_)
      - PROTOBUF_FIELD_OFFSET(DrmRunJobFtraceEvent, entity_)>(
          reinterpret_cast<char*>(&entity_),
          reinterpret_cast<char*>(&other->entity_));
}
...
class DrmSchedProcessJobFtraceEvent::_Internal {
 public:
  using HasBits = decltype(std::declval<DrmSchedProcessJobFtraceEvent>()._has_bits_);
  static void set_has_fence(HasBits* has_bits) {
    (*has_bits)[0] |= 1u;
  }
};
...
// @@protoc_insertion_point(class_specific_merge_from_start:perfetto.protos.DrmSchedProcessJobFtraceEvent)
  ...
  if (from._internal_has_fence()) {
    _internal_set_fence(from._internal_fence());
  }
  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
}
