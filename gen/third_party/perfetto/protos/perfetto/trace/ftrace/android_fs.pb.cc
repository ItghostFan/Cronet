...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 AndroidFsDatareadEndFtraceEventDefaultTypeInternal _AndroidFsDatareadEndFtraceEvent_default_instance_;
PROTOBUF_CONSTEXPR AndroidFsDatareadStartFtraceEvent::AndroidFsDatareadStartFtraceEvent(
    ::_pbi::ConstantInitialized)
  : cmdline_(&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{})
  , pathbuf_(&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{})
  , i_size_(int64_t{0})
  , ino_(uint64_t{0u})
  , bytes_(0)
  , pid_(0)
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 AndroidFsDatareadStartFtraceEventDefaultTypeInternal _AndroidFsDatareadStartFtraceEvent_default_instance_;
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 AndroidFsDatawriteEndFtraceEventDefaultTypeInternal _AndroidFsDatawriteEndFtraceEvent_default_instance_;
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 AndroidFsDatawriteStartFtraceEventDefaultTypeInternal _AndroidFsDatawriteStartFtraceEvent_default_instance_;
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 AndroidFsFsyncEndFtraceEventDefaultTypeInternal _AndroidFsFsyncEndFtraceEvent_default_instance_;
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 AndroidFsFsyncStartFtraceEventDefaultTypeInternal _AndroidFsFsyncStartFtraceEvent_default_instance_;
}  // namespace protos
}  // namespace perfetto
namespace perfetto {
namespace protos {
...
class AndroidFsDatareadEndFtraceEvent::_Internal {
 public:
  using HasBits = decltype(std::declval<AndroidFsDatareadEndFtraceEvent>()._has_bits_);
...
AndroidFsDatareadEndFtraceEvent::AndroidFsDatareadEndFtraceEvent(const AndroidFsDatareadEndFtraceEvent& from)
  ...
  ::memcpy(&ino_, &from.ino_,
    ...
    reinterpret_cast<char*>(&ino_)) + sizeof(bytes_));
...
void AndroidFsDatareadEndFtraceEvent::InternalSwap(AndroidFsDatareadEndFtraceEvent* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(AndroidFsDatareadEndFtraceEvent, bytes_)
      + sizeof(AndroidFsDatareadEndFtraceEvent::bytes_)
      - PROTOBUF_FIELD_OFFSET(AndroidFsDatareadEndFtraceEvent, ino_)>(
...
class AndroidFsDatareadStartFtraceEvent::_Internal {
 public:
  using HasBits = decltype(std::declval<AndroidFsDatareadStartFtraceEvent>()._has_bits_);
  static void set_has_bytes(HasBits* has_bits) {
    (*has_bits)[0] |= 16u;
  }
...
AndroidFsDatareadStartFtraceEvent::AndroidFsDatareadStartFtraceEvent(const AndroidFsDatareadStartFtraceEvent& from)
  : ::PROTOBUF_NAMESPACE_ID::MessageLite(),
      _has_bits_(from._has_bits_) {
  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
  cmdline_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    cmdline_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_cmdline()) {
    cmdline_.Set(from._internal_cmdline(), 
      GetArenaForAllocation());
  }
  pathbuf_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    pathbuf_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_pathbuf()) {
    pathbuf_.Set(from._internal_pathbuf(), 
      GetArenaForAllocation());
  }
  ::memcpy(&i_size_, &from.i_size_,
    static_cast<size_t>(reinterpret_cast<char*>(&offset_) -
    reinterpret_cast<char*>(&i_size_)) + sizeof(offset_));
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&i_size_) - reinterpret_cast<char*>(this)),
...
// @@protoc_insertion_point(message_clear_start:perfetto.protos.AndroidFsDatareadStartFtraceEvent)
  ...
  if (cached_has_bits & 0x00000003u) {
    if (cached_has_bits & 0x00000001u) {
      cmdline_.ClearNonDefaultToEmpty();
    }
    if (cached_has_bits & 0x00000002u) {
      pathbuf_.ClearNonDefaultToEmpty();
    }
  }
  if (cached_has_bits & 0x0000007cu) {
    ::memset(&i_size_, 0, static_cast<size_t>(
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 24)) {
          ...
          i_size_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
// @@protoc_insertion_point(class_specific_merge_from_start:perfetto.protos.AndroidFsDatareadStartFtraceEvent)
  ...
  if (cached_has_bits & 0x0000007fu) {
    ...
    if (cached_has_bits & 0x00000002u) {
      _internal_set_pathbuf(from._internal_pathbuf());
    }
    if (cached_has_bits & 0x00000004u) {
      i_size_ = from.i_size_;
    }
    if (cached_has_bits & 0x00000008u) {
      ino_ = from.ino_;
    }
...
void AndroidFsDatareadStartFtraceEvent::InternalSwap(AndroidFsDatareadStartFtraceEvent* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &pathbuf_, lhs_arena,
      &other->pathbuf_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(AndroidFsDatareadStartFtraceEvent, offset_)
      + sizeof(AndroidFsDatareadStartFtraceEvent::offset_)
      - PROTOBUF_FIELD_OFFSET(AndroidFsDatareadStartFtraceEvent, i_size_)>(
          reinterpret_cast<char*>(&i_size_),
          reinterpret_cast<char*>(&other->i_size_));
}
...
class AndroidFsDatawriteEndFtraceEvent::_Internal {
 public:
  using HasBits = decltype(std::declval<AndroidFsDatawriteEndFtraceEvent>()._has_bits_);
  static void set_has_bytes(HasBits* has_bits) {
    (*has_bits)[0] |= 4u;
  }
  static void set_has_ino(HasBits* has_bits) {
...
void AndroidFsDatawriteEndFtraceEvent::InternalSwap(AndroidFsDatawriteEndFtraceEvent* other) {
  ...
  swap(_has_bits_[0], other->_has_bits_[0]);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(AndroidFsDatawriteEndFtraceEvent, bytes_)
      + sizeof(AndroidFsDatawriteEndFtraceEvent::bytes_)
      - PROTOBUF_FIELD_OFFSET(AndroidFsDatawriteEndFtraceEvent, ino_)>(
          reinterpret_cast<char*>(&ino_),
          reinterpret_cast<char*>(&other->ino_));
}
...
class AndroidFsDatawriteStartFtraceEvent::_Internal {
 public:
  using HasBits = decltype(std::declval<AndroidFsDatawriteStartFtraceEvent>()._has_bits_);
  static void set_has_bytes(HasBits* has_bits) {
    (*has_bits)[0] |= 16u;
  }
  static void set_has_cmdline(HasBits* has_bits) {
...
void AndroidFsDatawriteStartFtraceEvent::InternalSwap(AndroidFsDatawriteStartFtraceEvent* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(AndroidFsDatawriteStartFtraceEvent, offset_)
      + sizeof(AndroidFsDatawriteStartFtraceEvent::offset_)
      - PROTOBUF_FIELD_OFFSET(AndroidFsDatawriteStartFtraceEvent, i_size_)>(
          reinterpret_cast<char*>(&i_size_),
          reinterpret_cast<char*>(&other->i_size_));
}
...
class AndroidFsFsyncEndFtraceEvent::_Internal {
 public:
  using HasBits = decltype(std::declval<AndroidFsFsyncEndFtraceEvent>()._has_bits_);
  static void set_has_bytes(HasBits* has_bits) {
    (*has_bits)[0] |= 4u;
  }
  static void set_has_ino(HasBits* has_bits) {
...
void AndroidFsFsyncEndFtraceEvent::InternalSwap(AndroidFsFsyncEndFtraceEvent* other) {
  ...
  swap(_has_bits_[0], other->_has_bits_[0]);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(AndroidFsFsyncEndFtraceEvent, bytes_)
      + sizeof(AndroidFsFsyncEndFtraceEvent::bytes_)
      - PROTOBUF_FIELD_OFFSET(AndroidFsFsyncEndFtraceEvent, ino_)>(
          reinterpret_cast<char*>(&ino_),
          reinterpret_cast<char*>(&other->ino_));
}
...
class AndroidFsFsyncStartFtraceEvent::_Internal {
 public:
  using HasBits = decltype(std::declval<AndroidFsFsyncStartFtraceEvent>()._has_bits_);
  static void set_has_cmdline(HasBits* has_bits) {
    (*has_bits)[0] |= 1u;
  }
  static void set_has_i_size(HasBits* has_bits) {
...
AndroidFsFsyncStartFtraceEvent::AndroidFsFsyncStartFtraceEvent(const AndroidFsFsyncStartFtraceEvent& from)
  ...
  ::memcpy(&i_size_, &from.i_size_,
    ...
    reinterpret_cast<char*>(&i_size_)) + sizeof(pid_));
...
void AndroidFsFsyncStartFtraceEvent::InternalSwap(AndroidFsFsyncStartFtraceEvent* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(AndroidFsFsyncStartFtraceEvent, pid_)
      + sizeof(AndroidFsFsyncStartFtraceEvent::pid_)
      - PROTOBUF_FIELD_OFFSET(AndroidFsFsyncStartFtraceEvent, i_size_)>(
          reinterpret_cast<char*>(&i_size_),
          reinterpret_cast<char*>(&other->i_size_));
}
