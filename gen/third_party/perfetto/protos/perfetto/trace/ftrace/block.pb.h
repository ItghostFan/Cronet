...
void BlockRqIssueFtraceEvent::set_rwbs(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 rwbs_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void BlockRqIssueFtraceEvent::_internal_set_rwbs(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  rwbs_.Set(value, GetArenaForAllocation());
}
inline std::string* BlockRqIssueFtraceEvent::_internal_mutable_rwbs() {
  _has_bits_[0] |= 0x00000001u;
  return rwbs_.Mutable(GetArenaForAllocation());
}
...
inline void BlockRqIssueFtraceEvent::set_allocated_rwbs(std::string* rwbs) {
  ...
  rwbs_.SetAllocated(rwbs, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (rwbs_.IsDefault()) {
    rwbs_.Set("", GetArenaForAllocation());
  }
