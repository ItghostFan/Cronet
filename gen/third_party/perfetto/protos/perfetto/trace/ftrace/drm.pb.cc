...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 DrmVblankEventFtraceEventDefaultTypeInternal _DrmVblankEventFtraceEvent_default_instance_;
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 DrmVblankEventDeliveredFtraceEventDefaultTypeInternal _DrmVblankEventDeliveredFtraceEvent_default_instance_;
}  // namespace protos
}  // namespace perfetto
namespace perfetto {
namespace protos {
...
class DrmVblankEventFtraceEvent::_Internal {
 public:
  using HasBits = decltype(std::declval<DrmVblankEventFtraceEvent>()._has_bits_);
...
DrmVblankEventFtraceEvent::DrmVblankEventFtraceEvent(const DrmVblankEventFtraceEvent& from)
  ...
  ::memcpy(&crtc_, &from.crtc_,
    static_cast<size_t>(reinterpret_cast<char*>(&seq_) -
    reinterpret_cast<char*>(&crtc_)) + sizeof(seq_));
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&crtc_) - reinterpret_cast<char*>(this)),
...
// @@protoc_insertion_point(message_clear_start:perfetto.protos.DrmVblankEventFtraceEvent)
  ...
  if (cached_has_bits & 0x0000000fu) {
    ::memset(&crtc_, 0, static_cast<size_t>(
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 16)) {
          ...
          high_prec_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
void DrmVblankEventFtraceEvent::InternalSwap(DrmVblankEventFtraceEvent* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(DrmVblankEventFtraceEvent, seq_)
      + sizeof(DrmVblankEventFtraceEvent::seq_)
      - PROTOBUF_FIELD_OFFSET(DrmVblankEventFtraceEvent, crtc_)>(
          reinterpret_cast<char*>(&crtc_),
          reinterpret_cast<char*>(&other->crtc_));
}
...
class DrmVblankEventDeliveredFtraceEvent::_Internal {
 public:
  using HasBits = decltype(std::declval<DrmVblankEventDeliveredFtraceEvent>()._has_bits_);
  static void set_has_crtc(HasBits* has_bits) {
    (*has_bits)[0] |= 2u;
  }
...
DrmVblankEventDeliveredFtraceEvent::DrmVblankEventDeliveredFtraceEvent(const DrmVblankEventDeliveredFtraceEvent& from)
  ...
  ::memcpy(&file_, &from.file_,
    static_cast<size_t>(reinterpret_cast<char*>(&seq_) -
    reinterpret_cast<char*>(&file_)) + sizeof(seq_));
...
void DrmVblankEventDeliveredFtraceEvent::InternalSwap(DrmVblankEventDeliveredFtraceEvent* other) {
  ...
  swap(_has_bits_[0], other->_has_bits_[0]);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(DrmVblankEventDeliveredFtraceEvent, seq_)
      + sizeof(DrmVblankEventDeliveredFtraceEvent::seq_)
      - PROTOBUF_FIELD_OFFSET(DrmVblankEventDeliveredFtraceEvent, file_)>(
