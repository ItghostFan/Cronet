...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 GpuMemTotalFtraceEventDefaultTypeInternal _GpuMemTotalFtraceEvent_default_instance_;
}  // namespace protos
}  // namespace perfetto
namespace perfetto {
namespace protos {
...
void GpuMemTotalFtraceEvent::InternalSwap(GpuMemTotalFtraceEvent* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(GpuMemTotalFtraceEvent, size_)
      + sizeof(GpuMemTotalFtraceEvent::size_)
      - PROTOBUF_FIELD_OFFSET(GpuMemTotalFtraceEvent, gpu_id_)>(
