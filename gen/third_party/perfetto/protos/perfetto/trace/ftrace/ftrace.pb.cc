...
PROTOBUF_CONSTEXPR PrintFtraceEvent::PrintFtraceEvent(
  ...
  : buf_(&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{})
  , ip_(uint64_t{0u}){}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 PrintFtraceEventDefaultTypeInternal _PrintFtraceEvent_default_instance_;
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 FuncgraphEntryFtraceEventDefaultTypeInternal _FuncgraphEntryFtraceEvent_default_instance_;
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 FuncgraphExitFtraceEventDefaultTypeInternal _FuncgraphExitFtraceEvent_default_instance_;
}  // namespace protos
}  // namespace perfetto
namespace perfetto {
namespace protos {
...
class FuncgraphEntryFtraceEvent::_Internal {
 public:
  using HasBits = decltype(std::declval<FuncgraphEntryFtraceEvent>()._has_bits_);
...
FuncgraphEntryFtraceEvent::FuncgraphEntryFtraceEvent(const FuncgraphEntryFtraceEvent& from)
  ...
  ::memcpy(&func_, &from.func_,
    ...
    reinterpret_cast<char*>(&func_)) + sizeof(depth_));
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 16)) {
          ...
          func_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
void FuncgraphEntryFtraceEvent::InternalSwap(FuncgraphEntryFtraceEvent* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(FuncgraphEntryFtraceEvent, depth_)
      + sizeof(FuncgraphEntryFtraceEvent::depth_)
      - PROTOBUF_FIELD_OFFSET(FuncgraphEntryFtraceEvent, func_)>(
...
class FuncgraphExitFtraceEvent::_Internal {
 public:
  using HasBits = decltype(std::declval<FuncgraphExitFtraceEvent>()._has_bits_);
...
FuncgraphExitFtraceEvent::FuncgraphExitFtraceEvent(const FuncgraphExitFtraceEvent& from)
  : ::PROTOBUF_NAMESPACE_ID::MessageLite(),
      _has_bits_(from._has_bits_) {
  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
  ::memcpy(&calltime_, &from.calltime_,
    static_cast<size_t>(reinterpret_cast<char*>(&depth_) -
    reinterpret_cast<char*>(&calltime_)) + sizeof(depth_));
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&calltime_) - reinterpret_cast<char*>(this)),
    0, static_cast<size_t>(reinterpret_cast<char*>(&depth_) -
    reinterpret_cast<char*>(&calltime_)) + sizeof(depth_));
}
...
// @@protoc_insertion_point(message_clear_start:perfetto.protos.FuncgraphExitFtraceEvent)
  ...
  if (cached_has_bits & 0x0000001fu) {
    ::memset(&calltime_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&depth_) -
        reinterpret_cast<char*>(&calltime_)) + sizeof(depth_));
  }
  _has_bits_.Clear();
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 8)) {
          ...
          calltime_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 40)) {
          ...
          rettime_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
void FuncgraphExitFtraceEvent::InternalSwap(FuncgraphExitFtraceEvent* other) {
  ...
  swap(_has_bits_[0], other->_has_bits_[0]);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(FuncgraphExitFtraceEvent, depth_)
      + sizeof(FuncgraphExitFtraceEvent::depth_)
      - PROTOBUF_FIELD_OFFSET(FuncgraphExitFtraceEvent, calltime_)>(
          reinterpret_cast<char*>(&calltime_),
          reinterpret_cast<char*>(&other->calltime_));
}
