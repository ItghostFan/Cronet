...
inline void BeginFrameArgs::clear_source_location_iid() {
  if (_internal_has_source_location_iid()) {
    created_from_.source_location_iid_ = uint64_t{0u};
...
inline ::perfetto::protos::SourceLocation* BeginFrameArgs::_internal_mutable_source_location() {
  if (!_internal_has_source_location()) {
    clear_created_from();
    set_has_source_location();
    created_from_.source_location_ = CreateMaybeMessage< ::perfetto::protos::SourceLocation >(GetArenaForAllocation());
  }
...
inline ::perfetto::protos::BeginFrameArgs* BeginImplFrameArgs::_internal_mutable_current_args() {
  if (!_internal_has_current_args()) {
    clear_args();
    set_has_current_args();
    args_.current_args_ = CreateMaybeMessage< ::perfetto::protos::BeginFrameArgs >(GetArenaForAllocation());
  }
...
inline ::perfetto::protos::BeginFrameArgs* BeginImplFrameArgs::_internal_mutable_last_args() {
  if (!_internal_has_last_args()) {
    clear_args();
    set_has_last_args();
    args_.last_args_ = CreateMaybeMessage< ::perfetto::protos::BeginFrameArgs >(GetArenaForAllocation());
  }
