...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 UnsymbolizedSourceLocationDefaultTypeInternal _UnsymbolizedSourceLocation_default_instance_;
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 SourceLocationDefaultTypeInternal _SourceLocation_default_instance_;
}  // namespace protos
}  // namespace perfetto
namespace perfetto {
namespace protos {
...
class UnsymbolizedSourceLocation::_Internal {
 public:
  using HasBits = decltype(std::declval<UnsymbolizedSourceLocation>()._has_bits_);
...
void UnsymbolizedSourceLocation::InternalSwap(UnsymbolizedSourceLocation* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(UnsymbolizedSourceLocation, rel_pc_)
      + sizeof(UnsymbolizedSourceLocation::rel_pc_)
      - PROTOBUF_FIELD_OFFSET(UnsymbolizedSourceLocation, iid_)>(
