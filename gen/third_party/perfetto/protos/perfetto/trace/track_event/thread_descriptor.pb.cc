...
PROTOBUF_CONSTEXPR ThreadDescriptor::ThreadDescriptor(
  ...
  : thread_name_(&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{})
  , pid_(0)
  , tid_(0)
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 ThreadDescriptorDefaultTypeInternal _ThreadDescriptor_default_instance_;
}  // namespace protos
}  // namespace perfetto
namespace perfetto {
namespace protos {
...
ThreadDescriptor::ThreadDescriptor(const ThreadDescriptor& from)
  ...
  thread_name_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    thread_name_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_thread_name()) {
    thread_name_.Set(from._internal_thread_name(), 
...
void ThreadDescriptor::InternalSwap(ThreadDescriptor* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &thread_name_, lhs_arena,
      &other->thread_name_, rhs_arena
  );
