...
PROTOBUF_CONSTEXPR CounterDescriptor::CounterDescriptor(
  ...
  : categories_()
  , unit_name_(&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{})
  , type_(0)
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 CounterDescriptorDefaultTypeInternal _CounterDescriptor_default_instance_;
}  // namespace protos
}  // namespace perfetto
namespace perfetto {
namespace protos {
...
CounterDescriptor::CounterDescriptor(const CounterDescriptor& from)
  ...
  unit_name_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    unit_name_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_unit_name()) {
    unit_name_.Set(from._internal_unit_name(), 
...
void CounterDescriptor::InternalSwap(CounterDescriptor* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &unit_name_, lhs_arena,
      &other->unit_name_, rhs_arena
  );
