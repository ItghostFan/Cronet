...
TracingServiceCapabilities::TracingServiceCapabilities(const TracingServiceCapabilities& from)
  ...
  ::memcpy(&has_query_capabilities_, &from.has_query_capabilities_,
    static_cast<size_t>(reinterpret_cast<char*>(&has_clone_session_) -
    reinterpret_cast<char*>(&has_query_capabilities_)) + sizeof(has_clone_session_));
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    0, static_cast<size_t>(reinterpret_cast<char*>(&has_clone_session_) -
    reinterpret_cast<char*>(&has_query_capabilities_)) + sizeof(has_clone_session_));
}
...
// @@protoc_insertion_point(message_clear_start:perfetto.protos.TracingServiceCapabilities)
  ...
  ::memset(&has_query_capabilities_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&has_clone_session_) -
      reinterpret_cast<char*>(&has_query_capabilities_)) + sizeof(has_clone_session_));
  _has_bits_.Clear();
    ...
    switch (tag >> 3) {
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 32)) {
          ...
          has_clone_session_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
// @@protoc_insertion_point(class_specific_merge_from_start:perfetto.protos.TracingServiceCapabilities)
  ...
  if (cached_has_bits & 0x00000007u) {
    ...
    if (cached_has_bits & 0x00000004u) {
      has_clone_session_ = from.has_clone_session_;
    }
...
void TracingServiceCapabilities::InternalSwap(TracingServiceCapabilities* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(TracingServiceCapabilities, has_clone_session_)
      + sizeof(TracingServiceCapabilities::has_clone_session_)
