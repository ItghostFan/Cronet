...
inline void PerfEvents_Timebase::clear_frequency() {
  if (_internal_has_frequency()) {
    interval_.frequency_ = uint64_t{0u};
    clear_has_interval();
  }
}
...
inline ::perfetto::protos::PerfEvents_Tracepoint* PerfEvents_Timebase::_internal_mutable_tracepoint() {
  if (!_internal_has_tracepoint()) {
    clear_event();
    set_has_tracepoint();
    event_.tracepoint_ = CreateMaybeMessage< ::perfetto::protos::PerfEvents_Tracepoint >(GetArenaForAllocation());
  }
...
inline ::perfetto::protos::PerfEvents_RawEvent* PerfEvents_Timebase::_internal_mutable_raw_event() {
  if (!_internal_has_raw_event()) {
    clear_event();
    set_has_raw_event();
    event_.raw_event_ = CreateMaybeMessage< ::perfetto::protos::PerfEvents_RawEvent >(GetArenaForAllocation());
  }
