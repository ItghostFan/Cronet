...
void ChromeConfig::set_trace_config(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 trace_config_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void ChromeConfig::_internal_set_trace_config(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  trace_config_.Set(value, GetArenaForAllocation());
}
inline std::string* ChromeConfig::_internal_mutable_trace_config() {
  _has_bits_[0] |= 0x00000001u;
  return trace_config_.Mutable(GetArenaForAllocation());
}
inline std::string* ChromeConfig::release_trace_config() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  auto* p = trace_config_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (trace_config_.IsDefault()) {
    trace_config_.Set("", GetArenaForAllocation());
  }
...
inline void ChromeConfig::set_allocated_trace_config(std::string* trace_config) {
  ...
  trace_config_.SetAllocated(trace_config, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (trace_config_.IsDefault()) {
    trace_config_.Set("", GetArenaForAllocation());
  }
...
inline void ChromeConfig::clear_json_agent_label_filter() {
  json_agent_label_filter_.ClearToEmpty();
...
void ChromeConfig::set_json_agent_label_filter(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000002u;
 json_agent_label_filter_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void ChromeConfig::_internal_set_json_agent_label_filter(const std::string& value) {
  _has_bits_[0] |= 0x00000002u;
  json_agent_label_filter_.Set(value, GetArenaForAllocation());
}
inline std::string* ChromeConfig::_internal_mutable_json_agent_label_filter() {
  _has_bits_[0] |= 0x00000002u;
  return json_agent_label_filter_.Mutable(GetArenaForAllocation());
}
inline std::string* ChromeConfig::release_json_agent_label_filter() {
  ...
  _has_bits_[0] &= ~0x00000002u;
  auto* p = json_agent_label_filter_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (json_agent_label_filter_.IsDefault()) {
    json_agent_label_filter_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  return p;
}
inline void ChromeConfig::set_allocated_json_agent_label_filter(std::string* json_agent_label_filter) {
  ...
  json_agent_label_filter_.SetAllocated(json_agent_label_filter, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (json_agent_label_filter_.IsDefault()) {
    json_agent_label_filter_.Set("", GetArenaForAllocation());
  }
