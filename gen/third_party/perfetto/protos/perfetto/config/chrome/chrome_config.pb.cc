...
PROTOBUF_CONSTEXPR ChromeConfig::ChromeConfig(
  ...
  : trace_config_(&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{})
  , json_agent_label_filter_(&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{})
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 ChromeConfigDefaultTypeInternal _ChromeConfig_default_instance_;
}  // namespace protos
}  // namespace perfetto
namespace perfetto {
namespace protos {
...
inline void ChromeConfig::SharedDtor() {
  ...
  trace_config_.Destroy();
  json_agent_label_filter_.Destroy();
}
...
void ChromeConfig::InternalSwap(ChromeConfig* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &trace_config_, lhs_arena,
      &other->trace_config_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &json_agent_label_filter_, lhs_arena,
      &other->json_agent_label_filter_, rhs_arena
  );
