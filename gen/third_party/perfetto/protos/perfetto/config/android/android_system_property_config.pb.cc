...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 AndroidSystemPropertyConfigDefaultTypeInternal _AndroidSystemPropertyConfig_default_instance_;
}  // namespace protos
}  // namespace perfetto
namespace perfetto {
namespace protos {
...
class AndroidSystemPropertyConfig::_Internal {
 public:
  using HasBits = decltype(std::declval<AndroidSystemPropertyConfig>()._has_bits_);
