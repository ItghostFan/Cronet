...
ProcessStatsConfig::ProcessStatsConfig(const ProcessStatsConfig& from)
  ...
  ::memcpy(&proc_stats_poll_ms_, &from.proc_stats_poll_ms_,
    static_cast<size_t>(reinterpret_cast<char*>(&scan_smaps_rollup_) -
    reinterpret_cast<char*>(&proc_stats_poll_ms_)) + sizeof(scan_smaps_rollup_));
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    0, static_cast<size_t>(reinterpret_cast<char*>(&scan_smaps_rollup_) -
    reinterpret_cast<char*>(&proc_stats_poll_ms_)) + sizeof(scan_smaps_rollup_));
}
...
// @@protoc_insertion_point(message_clear_start:perfetto.protos.ProcessStatsConfig)
  ...
  if (cached_has_bits & 0x0000003fu) {
    ::memset(&proc_stats_poll_ms_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&scan_smaps_rollup_) -
        reinterpret_cast<char*>(&proc_stats_poll_ms_)) + sizeof(scan_smaps_rollup_));
  }
  _has_bits_.Clear();
...
void ProcessStatsConfig::InternalSwap(ProcessStatsConfig* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(ProcessStatsConfig, scan_smaps_rollup_)
      + sizeof(ProcessStatsConfig::scan_smaps_rollup_)
