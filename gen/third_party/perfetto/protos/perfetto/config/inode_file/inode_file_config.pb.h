...
void InodeFileConfig_MountPointMappingEntry::set_mountpoint(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 mountpoint_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void InodeFileConfig_MountPointMappingEntry::_internal_set_mountpoint(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  mountpoint_.Set(value, GetArenaForAllocation());
}
inline std::string* InodeFileConfig_MountPointMappingEntry::_internal_mutable_mountpoint() {
  _has_bits_[0] |= 0x00000001u;
  return mountpoint_.Mutable(GetArenaForAllocation());
}
inline std::string* InodeFileConfig_MountPointMappingEntry::release_mountpoint() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  auto* p = mountpoint_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (mountpoint_.IsDefault()) {
...
inline void InodeFileConfig_MountPointMappingEntry::set_allocated_mountpoint(std::string* mountpoint) {
  ...
  mountpoint_.SetAllocated(mountpoint, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (mountpoint_.IsDefault()) {
    mountpoint_.Set("", GetArenaForAllocation());
  }
