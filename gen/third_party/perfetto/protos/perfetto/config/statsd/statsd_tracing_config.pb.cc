...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 StatsdTracingConfigDefaultTypeInternal _StatsdTracingConfig_default_instance_;
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 StatsdPullAtomConfigDefaultTypeInternal _StatsdPullAtomConfig_default_instance_;
}  // namespace protos
}  // namespace perfetto
namespace perfetto {
namespace protos {
...
StatsdTracingConfig::StatsdTracingConfig(const StatsdTracingConfig& from)
  : ::PROTOBUF_NAMESPACE_ID::MessageLite(),
      push_atom_id_(from.push_atom_id_),
      raw_push_atom_id_(from.raw_push_atom_id_),
      pull_config_(from.pull_config_) {
...
// @@protoc_insertion_point(message_byte_size_start:perfetto.protos.StatsdTracingConfig)
  ...
  // repeated int32 raw_push_atom_id = 2;
  {
    size_t data_size = ::_pbi::WireFormatLite::
      Int32Size(this->raw_push_atom_id_);
    total_size += 1 *
  ...
  for (const auto& msg : this->pull_config_) {
    total_size +=
...
// @@protoc_insertion_point(class_specific_merge_from_start:perfetto.protos.StatsdTracingConfig)
  ...
  push_atom_id_.MergeFrom(from.push_atom_id_);
  raw_push_atom_id_.MergeFrom(from.raw_push_atom_id_);
  pull_config_.MergeFrom(from.pull_config_);
  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
}
...
void StatsdTracingConfig::InternalSwap(StatsdTracingConfig* other) {
  ...
  push_atom_id_.InternalSwap(&other->push_atom_id_);
  raw_push_atom_id_.InternalSwap(&other->raw_push_atom_id_);
  pull_config_.InternalSwap(&other->pull_config_);
}
...
class StatsdPullAtomConfig::_Internal {
 public:
  using HasBits = decltype(std::declval<StatsdPullAtomConfig>()._has_bits_);
...
StatsdPullAtomConfig::StatsdPullAtomConfig(const StatsdPullAtomConfig& from)
  : ::PROTOBUF_NAMESPACE_ID::MessageLite(),
      ...
      pull_atom_id_(from.pull_atom_id_),
      raw_pull_atom_id_(from.raw_pull_atom_id_),
      packages_(from.packages_) {
  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
  pull_frequency_ms_ = from.pull_frequency_ms_;
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 24)) {
          ...
          pull_frequency_ms_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
// @@protoc_insertion_point(message_byte_size_start:perfetto.protos.StatsdPullAtomConfig)
  ...
  {
    size_t data_size = ::_pbi::WireFormatLite::
      Int32Size(this->raw_pull_atom_id_);
    total_size += 1 *
...
// @@protoc_insertion_point(class_specific_merge_from_start:perfetto.protos.StatsdPullAtomConfig)
  ...
  pull_atom_id_.MergeFrom(from.pull_atom_id_);
  raw_pull_atom_id_.MergeFrom(from.raw_pull_atom_id_);
  packages_.MergeFrom(from.packages_);
  if (from._internal_has_pull_frequency_ms()) {
    _internal_set_pull_frequency_ms(from._internal_pull_frequency_ms());
  }
  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
}
...
void StatsdPullAtomConfig::InternalSwap(StatsdPullAtomConfig* other) {
  ...
  pull_atom_id_.InternalSwap(&other->pull_atom_id_);
  raw_pull_atom_id_.InternalSwap(&other->raw_pull_atom_id_);
  packages_.InternalSwap(&other->packages_);
  swap(pull_frequency_ms_, other->pull_frequency_ms_);
}
