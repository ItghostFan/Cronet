...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 TrackEventConfigDefaultTypeInternal _TrackEventConfig_default_instance_;
}  // namespace protos
}  // namespace perfetto
namespace perfetto {
namespace protos {
...
TrackEventConfig::TrackEventConfig(const TrackEventConfig& from)
  ...
  ::memcpy(&timestamp_unit_multiplier_, &from.timestamp_unit_multiplier_,
    static_cast<size_t>(reinterpret_cast<char*>(&filter_dynamic_event_names_) -
    reinterpret_cast<char*>(&timestamp_unit_multiplier_)) + sizeof(filter_dynamic_event_names_));
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    0, static_cast<size_t>(reinterpret_cast<char*>(&filter_dynamic_event_names_) -
    reinterpret_cast<char*>(&timestamp_unit_multiplier_)) + sizeof(filter_dynamic_event_names_));
}
...
// @@protoc_insertion_point(message_clear_start:perfetto.protos.TrackEventConfig)
  ...
  if (cached_has_bits & 0x0000001fu) {
    ::memset(&timestamp_unit_multiplier_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&filter_dynamic_event_names_) -
        reinterpret_cast<char*>(&timestamp_unit_multiplier_)) + sizeof(filter_dynamic_event_names_));
  }
  _has_bits_.Clear();
    ...
    switch (tag >> 3) {
      ...
      case 9:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 72)) {
          ...
          filter_dynamic_event_names_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
// @@protoc_insertion_point(class_specific_merge_from_start:perfetto.protos.TrackEventConfig)
  ...
  if (cached_has_bits & 0x0000001fu) {
    ...
    if (cached_has_bits & 0x00000010u) {
      filter_dynamic_event_names_ = from.filter_dynamic_event_names_;
    }
...
void TrackEventConfig::InternalSwap(TrackEventConfig* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(TrackEventConfig, filter_dynamic_event_names_)
      + sizeof(TrackEventConfig::filter_dynamic_event_names_)
