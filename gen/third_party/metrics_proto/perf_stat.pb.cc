...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 PerfStatProto_PerfStatLineDefaultTypeInternal _PerfStatProto_PerfStatLine_default_instance_;
PROTOBUF_CONSTEXPR PerfStatProto::PerfStatProto(
    ::_pbi::ConstantInitialized)
  : line_()
  , command_line_(&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}){}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 PerfStatProtoDefaultTypeInternal _PerfStatProto_default_instance_;
}  // namespace metrics
namespace metrics {
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&time_ms_) - reinterpret_cast<char*>(this)),
...
void PerfStatProto_PerfStatLine::InternalSwap(PerfStatProto_PerfStatLine* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(PerfStatProto_PerfStatLine, count_)
      + sizeof(PerfStatProto_PerfStatLine::count_)
      - PROTOBUF_FIELD_OFFSET(PerfStatProto_PerfStatLine, time_ms_)>(
          reinterpret_cast<char*>(&time_ms_),
          reinterpret_cast<char*>(&other->time_ms_));
}
